...
var Event = defineDocumentType(() => ({
  ...
  fields: {
    ...
    // Added based on leadership-workshop content
  },
  computedFields: {
    url_path: {
      type: "string",
...
//# sourceMappingURL=compiled-contentlayer-config-2BY4B5PH.mjs.map

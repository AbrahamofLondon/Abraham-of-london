...
export function getAllEventsMeta(): Event[] {
  try {
    ...
    return metas.map((m: any) => fromMdxMeta(m));
  } catch (error) {
...
export async function getEventBySlug(slug: string): EventWithContent | null {
  try {
...
return resolved ? fromMdxDocument(resolved) : null;
  } catch (error) {

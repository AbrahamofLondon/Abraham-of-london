...
import { getGmiBoardPulseData, getLatestPublishedEditionId } from "@/lib/intelligence/gmi-data-service.server";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await getGmiBoardPulseData(editionId);

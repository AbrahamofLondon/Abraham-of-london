/* app/briefs/[slug]/page.tsx — BUILD-TIME PRERENDERED (ISR) */
...
/**
 * Prerender all public briefs at build time.
 * Reads from the static JSON registry (public/system/briefs-registry.json)
 * which is generated by scripts/generate-briefs-registry.mjs after the
 * contentlayer2 build step. No filesystem access to .contentlayer/ at runtime.
 */
export async function generateStaticParams() {
  const briefs = getAllBriefsFromRegistry();
  return briefs
    .filter((b) => b.publishedSafe && b.accessTierSafe === "public")
    .map((b) => ({ slug: b.slug }))
    .filter((b) => b.slug);
}
 ...
 * No filesystem access to .contentlayer/generated/ at runtime.
 */

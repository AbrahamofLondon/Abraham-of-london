  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <p className="mb-8 text-[color:var(--color-on-secondary)/0.85]">
        Everything in this list is read straight from{" "}
        <code>/public/downloads</code>. Drop in a new PDF and it appears here on
        next build.
      </p>

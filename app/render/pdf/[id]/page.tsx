...
export default async function PDFRenderPage({ params }: Props) {
  ...
  const isPublic = String(pdf.tier || "public") === "public";
        ...
        <div className="flex justify-between items-start">
          <div className="space-y-1">
            <span className="text-[0.625rem] uppercase tracking-[0.2em] text-[#D4AF37] font-sans font-bold">
              {isPublic ? "Public Release" : "Intelligence Brief"}
            </span>
            <h1 className="text-5xl font-medium leading-tight font-serif">{pdf.title}</h1>
          ...
          <div className="space-y-8">
            <section className="border-l-2 border-[#D4AF37] pl-8 py-2">
              ...
              <p className="text-lg leading-relaxed text-gray-700 italic">
                {pdf.description ||
                  "This framework serves as a canonical reference for the London-based intelligence portfolio."}
              </p>
            </section>

            <div className="grid grid-cols-2 gap-12 mt-12">
              <div className="p-6 bg-gray-50 border border-gray-100 rounded-sm">
                <h3 className="text-sm font-sans uppercase tracking-widest text-[#D4AF37] mt-0 font-bold">
                  Core Principles
                </h3>
              ...
              <div className="p-6 bg-[#050505] text-[#fdfaf3] rounded-sm shadow-xl">
                <h3 className="text-sm font-sans uppercase tracking-widest text-[#f59e0b] mt-0 font-bold">
                  Required Action
                </h3>
                <p className="text-xs leading-relaxed opacity-80 mt-4">
                  Review this brief against current operational cadences to ensure alignment with the overarching legacy
                  architecture.
                </p>
              </div>
            </div>
      ...
      <footer className="p-12 pt-0 absolute bottom-0 w-full">
        <div className="border-t border-gray-100 pt-8 flex justify-between items-end">
          <div className="text-[0.625rem] uppercase font-sans text-gray-400">
            ...
            <p className="mt-1 font-mono tracking-normal">STRICTLY CONFIDENTIAL // {String(pdf.tier).toUpperCase()}</p>
          </div>
          <div className="text-right">
            <span className="text-[0.625rem] font-sans text-gray-300 uppercase tracking-widest">

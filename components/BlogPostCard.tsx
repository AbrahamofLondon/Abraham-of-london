...
export default function BlogPostCard({ post, priority = false }: BlogPostCardProps) {
  ...
  return (
    <article className="group relative overflow-hidden rounded-3xl bg-white/95 backdrop-blur-sm shadow-2xl shadow-black/10 border border-white/20 transition-all duration-700 hover:shadow-3xl hover:shadow-black/20 hover:-translate-y-2">
      ...
      <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-softGold/0 via-softGold/10 to-forest/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      ...
      <Link href={href} className="block relative z-10" prefetch={false}>
        ...
        <div className="relative p-6">
          ...
          <h3 className="mb-3 font-serif text-xl md:text-2xl font-light text-deepCharcoal leading-tight group-hover:text-forest transition-colors duration-300 line-clamp-2">
            {post.title}
          </h3>

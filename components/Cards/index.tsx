...
// Export all types
export type { BaseCardProps, DocumentCardProps } from './BaseCard';
...
export const CARD_ANIMATIONS = {
  ...
  focus: 'focus:outline-none focus:ring-2 focus:ring-softGold/50 focus:ring-offset-1 focus:ring-offset-black',
...
export function getAuthorName(author: unknown): string {
  ...
  if (typeof author === 'object' && author !== null) {
    ...
    return String(authorObj.name || authorObj.displayName || getCardFallbackConfig().defaultAuthor);
  }
...
export function createCardClassName(
  ...
  if (hover) {
    classes.push(CARD_ANIMATIONS.hover, CARD_ANIMATIONS.focus, CARD_ANIMATIONS.active);
  }
 ...
 */
export function renderCardDate(dateString?: string | null): React.ReactNode {

...
export default function EnhancedFooter(): React.ReactElement {
  ...
  "Your Account": [
    ...
    { label: "My Instruments", href: "/my-instruments" },
    { label: "Instrument History", href: "/decision-instruments/history" },
    { label: "Boardroom", href: "/boardroom" },
    { label: "Retainer Readiness", href: "/retainer" },
  ...
  "Trust & Proof": [
    ...
    { label: "Why Not AI", href: "/why-not-ai" },
  ...
  Governance: [
    ...
    { label: "Works in Progress", href: "/works-in-progress" },

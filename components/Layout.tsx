...
// Footer component (inline, unchanged)
const Footer = () => (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link href="/inner-circle/dashboard" className="text-gray-600 hover:text-blue-600">Dashboard</Link></li>
            <li><Link href="/inner-circle/content" className="text-gray-600 hover:text-blue-600">Content Library</Link></li>
            <li><Link href="/inner-circle/profile" className="text-gray-600 hover:text-blue-600">Your Profile</Link></li>
            <li><Link href="/inner-circle/settings" className="text-gray-600 hover:text-blue-600">Settings</Link></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="/contact" className="text-gray-600 hover:text-blue-600">Contact Support</Link></li>
...
const Layout: React.FC<LayoutProps> = ({
  ...
  // ✅ AUTHENTICATION IS HANDLED BY PROXY – no client‑side redirects

  ...
  return (
    ...
    >
      ...
      >
        ...
        governance into the same room. No flattery. No motivational sugar.
        Just clear thinking, moral courage, and concrete decisions that respect
        both calling and consequence.
      </motion.p>

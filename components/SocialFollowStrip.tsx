...
export function XIcon(props: IconProps) {
  ...
  return (
    <svg {...withA11yProps(props)} viewBox="0 0 24 24" style={svgStyle(color)} fill="none">
...
export function MailIcon(props: IconProps) {
  ...
  return (
    <svg {...withA11yProps(props)} viewBox="0 0 24 24" style={svgStyle(color)} fill="none">
      <rect x="3" y="6" width="18" height="12" rx="2" style={strokeCC} strokeWidth="1.8" />
...
export function DefaultLinkIcon(props: IconProps) {
  ...
  return (
    <svg {...withA11yProps(props)} viewBox="0 0 24 24" style={svgStyle(color)} fill="none">
      <path d="M10 13a5 5 0 0 0 7.07 0l2.83-2.83a5 5 0 0 0-7.07-7.07L11 4" style={strokeCC} strokeWidth="1.8" />
      <path d="M14 11a5 5 0 0 0-7.07 0L4.1 13.83a5 5 0 0 0 7.07 7.07L13 20" style={strokeCC} strokeWidth="1.8" />
    </svg>
  );
}

/* ---------- Icon map ---------- */
const ICONS: Record<NonNullable<SocialItem["kind"]>, (p: IconProps) => React.ReactElement> = {
  tiktok: TikTokIcon,
  x: XIcon,

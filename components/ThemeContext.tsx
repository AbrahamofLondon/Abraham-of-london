...
const ContentCase: React.FC<ContentCaseProps> = ({
  item,
  variant = "elegant",
}) => {
      ...
      <GlassCard hover={false}>
        <div className="p-6">
          <div className="flex items-center gap-3 mb-3">
            <div
              className={`p-2 rounded-xl border ${getKindAccent(item.kind)}`}
            >
              {ContentIcons[item.kind]}
            </div>
            <span
              className={`text-xs font-medium px-2 py-1 rounded-full border ${getKindAccent(item.kind)}`}
            >
              {item.kind}
            </span>
          </div>
      ...
      <GlassCard>
        ...
        >
          <div className="flex items-start justify-between mb-6">
            <div
              className={`p-3 rounded-2xl border ${getKindAccent(item.kind)}`}
            >
              {ContentIcons[item.kind]}
            </div>
            <div className="text-right">
              <span
                className={`text-xs font-semibold px-3 py-1 rounded-full border ${getKindAccent(item.kind)}`}
              >
                {item.kind}
              </span>
              {item.date && (
  ...
  return (
    <GlassCard>
      ...
      >
        ...
        <div className="mb-2">
          <span
            className={`text-xs font-semibold px-2 py-1 rounded-full border ${getKindAccent(item.kind)}`}
          >
            {item.kind}
          </span>
        </div>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-white/10">
          ...
          >
            {ctaLabel}
            <ArrowIcon
              className={`h-3 w-3 transform ${isHovered ? "translate-x-1" : ""}`}
            />
          </Link>
        </div>
      </div>
  ...
  return (
    <Layout title="Strategic Insights & Resources">
      <Head>
        ...
        <meta
          name="description"
          content="Master strategic thinking with curated essays, premium tools, and wisdom resources for leaders building enduring legacies."
        />
        <meta
          name="keywords"
          content="strategy, leadership, legacy, wisdom, resources, tools, essays"
        />
      </Head>
      ...
      <div className="min-h-screen bg-black text-white overflow-hidden">
        ...
        <section className="relative min-h-screen flex items-center justify-center px-4">
          ...
          <div className="relative z-10 max-w-6xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-softGold/30 bg-softGold/10 px-6 py-3 mb-8 backdrop-blur-sm">
              <span className="text-softGold text-sm font-light tracking-widest">
                WISDOM ATELIER
              </span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed font-light">
              Curated strategic wisdom, premium tools, and master resources for
              visionary leaders building enduring impact across generations.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <button
                onClick={() =>
                  document
                    .getElementById("content-gallery")
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                  Hand-selected strategic resources of exceptional quality and
                  impact
                </p>
              </div>
        ...
        <section id="content-gallery" className="relative py-20 px-4">
          <div className="max-w-7xl mx-auto">
            {/* Gallery Header */}
            <div
              className={`sticky top-24 z-20 mb-12 transition-all duration-500 ${isScrolled ? "bg-black/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl" : ""}`}
            >
          ...
          <div className="max-w-4xl mx-auto text-center">
            <GlassCard className="p-12 md:p-16">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
                Join visionary leaders and founders who are transforming their
                strategic approach to build enduring impact that transcends
                generations.
              </p>

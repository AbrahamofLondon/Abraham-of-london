...
export default function Ventures() {
  ...
  return (
    <section id="ventures" className="py-20 px-4">
      ...
      >
        <motion.h2 className="text-4xl md:text-5xl font-extrabold mb-4 text-gray-900" variants={itemVariants}>
          My Ventures & Brands
        </motion.h2>
        <motion.p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-16" variants={itemVariants}>
        ...
        >
          ...
          <div className="text-center md:text-left">
            <h3 className="text-4xl md:text-5xl font-bold mb-4 text-gray-800">Abraham of London</h3>

  ...
  return (
    <div className="rounded-[28px] border border-white/10 bg-black/30 p-8 text-white shadow-sm">
      ...
      <h2 className="mt-4 font-serif text-3xl font-light tracking-tight">
        Continue in the canonical team assessment flow
      </h2>
      <p className="mt-4 max-w-3xl text-sm leading-7 text-white/65">
        This legacy surface has been retired. The governed team assessment now
        runs through the main diagnostic route and returns a public-safe reading:
        state, posture, directive, required action, and recommended next step.
      </p>

...
export default function TeaserEmail({ name, siteUrl }: Props) {
  // ✅ Use the standardized filenames
  const A4 = `${siteUrl}/downloads/Fathering_Without_Fear.pdf`;
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        the sons looking for language, and anyone who’s wrestled with God and grief at the same
        time.
      </p>
      ...
      <p>
        ...
        {link(`${siteUrl}/contact`, `${siteUrl}/contact`)}.
      </p>

        ...
        >
          ...
          <div className="mt-5">
            <Link
              href="/contact"
              prefetch={false}
              className="inline-flex w-full items-center justify-center rounded-lg bg-forest px-6 py-3 font-semibold text-cream transition-colors hover:bg-forest/90 focus:outline-none focus:ring-2 focus:ring-forest focus:ring-offset-2 text-lg"
                  ...
                  const body = (
                    <div className="flex items-start gap-4 rounded-xl border border-lightGrey bg-warmWhite p-4 shadow-sm hover:shadow-md transition">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-sm mt-0.5 text-gray-600 dark:text-gray-300">

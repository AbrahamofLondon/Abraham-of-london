// components/VenturesSection.tsx
...
/* InnovateHub URLs (env-first, then your Netlify subdomain) */
      ...
      <div className="container mx-auto max-w-6xl">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={container}
          ...
          <motion.header variants={item} className="mb-10">
            ...
            <p className="text-lg md:text-xl text-deepCharcoal/80 max-w-2xl">A portfolio at the intersection of strategy, sustainability, and impact.</p>
          </motion.header>

          {/* House brand banner */}
          <motion.div variants={item} className="bg-white p-6 md:p-8 rounded-2xl shadow-xl ring-1 ring-black/10 mb-12 flex flex-col md:flex-row items-center gap-6 md:gap-10">
            <div className="relative w-[220px] h-[110px] flex-shrink-0">
              <Image src="/assets/images/logo/abraham-of-london-logo.svg" alt="Abraham of London brand logo" fill sizes="220px" className="object-contain" priority />
            </div>
            <div className="text-center md:text-left">
              <h3 className="text-3xl md:text-4xl font-bold mb-2 text-gray-900">Abraham of London</h3>
              <p className="text-deepCharcoal/80">Strategic stewardship, thought leadership, and the standards that hold the family together.</p>
              <div className="mt-4">
          ...
          <motion.div variants={container} className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {brandsData.map((b) => <BrandCard key={b.name} brand={b} />)}
          </motion.div>

...
const surfaces = [
  ...
  },
  {
    ...
    label: "Decision Delay Exposure Instrument",
    summary: "Scenario-based exposure reading with financial drag, governance pressure, and the next move.",
  ...
  },
  {
    ...
    summary: "Inspect client-safe proof: accountability statement, confidence bands, timeline, hash, and anchor posture.",

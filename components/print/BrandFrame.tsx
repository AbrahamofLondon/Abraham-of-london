...
export default function BrandFrame({
  ...
  const siteHost = React.useMemo(() => siteUrl.replace(/^https?:\/\//, ""), []);
  ...
  return (
    <>
      ...
      <style jsx global>{`
        @media print {
          /* Explicit color definitions for print consistency */
          :root {
            --color-primary: ${BRAND_PRIMARY_COLOR};
            --color-on-secondary: ${TEXT_COLOR};
            --color-accent: ${BRAND_ACCENT_COLOR};
          }

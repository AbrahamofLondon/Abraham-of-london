...
ogDescription: >-
  Brotherhood is not a chat thread. It's a covenant of presence. Start a 90-day pilot with 3-5 men: a simple code, a repeatable rhythm, and resources you can run this weekend.
socialCaption: >-
  Men of presence > men of opinions. Start a 90-day brotherhood: show up, tell the truth, protect families, build together. #Fatherhood #Brotherhood #Formation
...
import { HeroEyebrow, Verse, PullLine, Rule, Callout, Note, ShareRow, BadgeRow, Badge, Grid, DownloadCard, CTA, Quote } from "@/components/utils"; // Assuming utility components
    ...
    <>
      ...
      **The Stack**
      ...
      <Grid columns="2">
        ...
        <DownloadCard title="Brotherhood Covenant (Printable)" href="/downloads/brotherhood-covenant.pdf" meta="One-page Signable" />
        <DownloadCard title="Leaders Cue Card (A6, Two-Up)" href="/downloads/brotherhood-cue-card.pdf" meta="Cut-and-carry Weekly rhythm" />
      </Grid>

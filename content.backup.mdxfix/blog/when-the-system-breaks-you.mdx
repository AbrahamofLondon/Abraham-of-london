...
type: "Post"
description: >-
  The spiritual cost of fighting impossible systems and the path back to sovereignty.
ogDescription: >-
  A man's field notes on finding faith and sovereignty after a systems failure.
socialCaption: >-
  A man's field notes on finding faith and sovereignty after a systems failure.
...
import { Rule, Verse, PullLine } from '@/components/utils';

...
description: ">-
  Why Christian confession isn’t extremism: Jesus as Lord, the cross-shaped
  means of change, and the historic fruits of the Gospel—written as a father’s
  charge to walk in light with courage and kindness."
ogTitle: "Christianity ≠ Extremism"
ogDescription: ">-
  Origins, means, and fruits: a father’s case for Christian witness as light,
  not extremism."
socialCaption: ">-
  Christianity isn’t extremism. It’s the way of the Crucified—truth with
  tenderness, power through service, light for every neighbour. #JesusIsLord
  #Apologetics #Fatherhood"
date: "2025-08-28" # <-- CORRECTED: Date wrapped in quotes
author: "Abraham of London"
excerpt: ">-
  Why Christianity cannot be lumped under the banner of extremism: a call for
  fathers to stand as light and salt in an age that mislabels truth."
readTime: "6 min read"

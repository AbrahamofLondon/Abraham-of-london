...
ogTitle: "Christianity is Not Extremism"
ogDescription: "Christianity stands or falls with Jesus Christ. The Gospel advances by witness and costly love, not coercion."
socialCaption: "Christianity isn't extremism. It's the cross-shaped way of truth and tenderness that built hospitals, schools, and hope. Walk in the light."
date: "2025-08-28"
...
import { ResourcesCTA, BrandFrame, HeroEyebrow, Rule, PullLine, Verse, Caption, Note, ShareRow, JsonLd } from "@/components/mdx'; 

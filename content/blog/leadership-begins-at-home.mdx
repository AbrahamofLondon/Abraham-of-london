...
<ResourcesCTA title="Keep Walking — Readings & Tools" reads={[
  ...
  { href: "/downloads/Standards_Brief.pdf", label: "Self-Governance Standards Brief" },
  { href: "/downloads/weekly-operating-rhythm\.pdf", label: "Weekly Operating Rhythm Guide" }
]} />

...
**Decision latency increases.** The time between identifying a problem and acting on it stretches. Not because the problem is harder. Because the organisation has lost its hierarchy of judgement. Everything is equally important, which means nothing is urgent.

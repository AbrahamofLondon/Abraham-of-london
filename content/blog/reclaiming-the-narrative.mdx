...
<table>
  ...
  <tbody>
    <tr><td><strong>Time &amp; Communication</strong></td><td>Dates, calls, messages, missed time, refused access.</td></tr>
    <tr><td><strong>Involvement</strong></td><td>School runs, homework, meetings, medical and extracurriculars.</td></tr>
    <tr><td><strong>Financial Support</strong></td><td>All receipts and bank records. Add useful references.</td></tr>
    <tr><td><strong>Interference</strong></td><td>Late cancellations, withheld info, threats — <strong>facts, not flames</strong>.</td></tr>
    <tr><td><strong>Third-Party Observations</strong></td><td>Teachers, coaches, faith leaders — brief factual notes.</td></tr>
  </tbody>
</table>

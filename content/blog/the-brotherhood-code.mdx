...
<Grid columns="2">
  <DownloadCard
    ...
    href="/vault/downloads/brotherhood-starter-kit.pdf"
    meta="Printable PDF • A4/Letter"
  />
  <DownloadCard
    title="Leader Guide - First 4 Weeks"
    href="/vault/downloads/brotherhood-leader-guide.pdf"
    meta="Printable PDF • A4/Letter"
  />
  <DownloadCard
    title="Brotherhood Covenant (Printable)"
    href="/vault/downloads/brotherhood-covenant.pdf"
    meta="One-page • Signable"
  />
  <DownloadCard
    title="Leader's Cue Card (A6, Two-Up)"
    href="/vault/downloads/brotherhood-cue-card.pdf"

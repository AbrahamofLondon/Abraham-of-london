...
<table>
  ...
  <tbody>
    <tr><td><strong>Integrity</strong></td><td>To keep a small promise, even when it’s inconvenient.</td></tr>
    <tr><td><strong>Discipline</strong></td><td>The structure of work, the importance of finishing a task, and how to manage conflict.</td></tr>
    <tr><td><strong>Humility</strong></td><td>How to admit when he is wrong, apologize fully, and seek forgiveness.</td></tr>
    <tr><td><strong>Resilience</strong></td><td>How to handle failure, take calculated risks, and get back up without complaint.</td></tr>
  </tbody>
</table>

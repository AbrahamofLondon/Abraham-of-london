...
subtitle: "A Practical Framework for Finding Structural Disorder Before It Becomes Failure"
description: "A practical diagnostic brief for leaders who need to identify where governance is failing inside a person, team, or institution. It focuses on decision rights, operating cadence, documented truth, and the structural conditions required to restore order."
date: "2026-02-24"
version: "1.1.0"
...
decisionMetadata:
  ...
  transformationStage:
    ...
    - realign
  notes: >
    A practical governance diagnostic focused on structural order rather than
    sentiment. Helps leaders identify breakdowns in authority, rhythm,
    documentation, accountability, and enforcement before those breakdowns
...
**Diagnostic Rule**: Disorder is rarely caused by low effort alone. More often it is caused by unclear ownership, weak boundaries, undocumented truth, and standards without enforcement.
</BriefAlert>
...
<DocumentFooter>
**Version**: 1.1.0 | **Institutional ID**: CB-GOV-DIAG-077

...
subtitle: "A Foundational Audit for Alignment Between Public Claims and Operating Reality"
description: "A practical audit for leaders who need to verify whether their institution's internal behaviour matches its stated mission, values, and governing language. It is designed to expose the gap between aspiration and actual structural integrity before growth amplifies the fracture."
date: "2026-02-24"
version: "1.3.0"
...
decisionMetadata:
  ...
  requiredInterventions:
    - Clarify institutional constitution and language
    - Restore governance discipline
    - Tighten accountability structures
    - Freeze growth until foundations are repaired
  marketRiskBands:
    - MEDIUM
    - HIGH
  sponsorTypes:
  ...
  transformationStage:
    ...
    - realign
  notes: >
    A foundational audit for determining whether an institution's internal
    reality matches its public claims. Structured around constitutional,
    operational, and behavioural integrity, with explicit guidance on when to
    halt growth in order to repair structural dishonesty.
---
...
**Lexicon**: [Integrity](/lexicon/integrity) · [Governance](/lexicon/governance) · [Responsibility](/lexicon/responsibility)
...
**Audit Rule**: Integrity is not a brand adjective. It is the measurable alignment between what the institution says, what it permits, and what it repeatedly does.
</BriefAlert>
...
If the audit reveals overall integrity below a credible operating threshold, growth should be frozen until repair begins.
...
<DocumentFooter>
**Version**: 1.3.0 | **Institutional ID**: CB-INT-AUDIT-078

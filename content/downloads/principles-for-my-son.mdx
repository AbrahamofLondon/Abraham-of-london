...
const PrinciplesForMySon = () => {
  return (
    ...
    >
      ...
      <h3 className="mt-8">Daily Rhythm</h3>
      ...
      <h3 className="mt-8">Weekly Touchpoints</h3>
      <ul className="list-disc pl-5 space-y-2">
            ...
            <div className="mb-4 border-b border-lightGrey pb-4">
              <div className="h-6">
                <EmbossedSign 
                    ...
                    alt={`${role} signature line`}
                    width={180} height={30} effect="deboss" baseColor="transparent" className="block"
                />
              </div>

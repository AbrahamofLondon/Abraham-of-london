...
resources:
  downloads:
    - { label: "Leader’s Cue Card (A6, Two-Up)", href: "/downloads/leaders-cue-card", kind: "pdf" }
    - { label: "Weekly Operating Rhythm — 30•60•90", href: "/downloads/weekly-operating-rhythm", kind: "pdf" }
    - { label: "Entrepreneur Operating Pack", href: "/downloads/entrepreneur-operating-pack", kind: "pdf" }
related:

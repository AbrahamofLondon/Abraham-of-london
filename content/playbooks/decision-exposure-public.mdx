...
Naming the cost is the first step. Without a structured enforcement path, the named cost becomes another data point in the discussion — acknowledged but not acted on.

...
# The Brotherhood Code Ã¢â‚¬â€ Starter Kit (One-Page Covenant)
...
4. **Protect families.** No gossip. No shortcuts. **Cover, donÃ¢â‚¬â„¢t expose.**
5. **Build together.** Study, train, serve. **Produce Ã¢â‚¬â€ not just post.**

---

## Meeting Rhythm (90 minutes)
- **45 min Ã¢â‚¬â€ Scripture + Discussion** (foundation)
- **30 min Ã¢â‚¬â€ Formation** (habits, money, marriage, parenting)
- **15 min Ã¢â‚¬â€ Intercession** (names, needs, next steps)
...
- **Scribe:** captures 1Ã¢â‚¬â€œ3 actions per man
...
Chronic lateness w/o ownership, secrecy, triangulation, spiritual oneÃ¢â‚¬â€˜upmanship.

...
## Overview
This collection brings together time-tested strategic frameworks used by leaders, founders, and builders to make better decisions and execute more effectively.

## Included Frameworks

### 1. The Purpose Pyramid
- **Use**: Defining organizational or personal purpose
- **Levels**: Survival, Success, Significance, Legacy
- **Application**: Annual planning, team alignment

### 2. The Decision Matrix
- **Use**: Making complex decisions
...
Purpose becomes a slogan; strategy becomes improvisation.
...
4. **Legacy** — build what outlives you (institutions, culture, succession)
...
- Leadership values (non-negotiables)
- Stakeholder reality (customers, staff, dependents)

**Process**
1. **Diagnose the current level** (don’t pretend you’re at Legacy if you’re fighting payroll)
...
4. Translate into:
   ...
   - **Operating priorities** (private discipline)
   - **Kill list** (what must stop)

**Outputs**
- Purpose statement that governs choices
...
- Skipping levels (Legacy talk with Survival performance)
...
- Existing assets (skills, writings, relationships)
- Real threats (drift, scandal, instability)

**Process**
For each dimension:
- Define **what you want to leave**
- Define **what currently threatens it**
- Define **a 12-month build plan**
- Define **a 3-year institutional plan**

**Outputs**
- One-page legacy blueprint
- Personal governance commitments
- Succession and mentorship roadmap
- Asset map (what becomes a system)

**Failure modes**
- Treating legacy like branding
- Building wealth without building character
...
- **The Governance Ladder** (role clarity, authority, escalation)
...
- **Application**: Multi-generational planning
...
This is how drift becomes respectable. The organisation moves collectively toward a position that everyone can accept but no one is accountable for executing. The decision exists in language only. It has no operational weight.

...
He was also a merchant. Kola nuts. Cocoa. He held land. He built.
...
*Market-ready body pass. Scene architecture in four movements: (1) Isua and kingmaker lineage, (2) the name earned through wealth, (3) the missionary tailor encounter — the chapter's physical anchor, (4) unfinished inheritance. All author details resolved: agbada robes and charcoal iron (tailoring), boolekaja to Osun then walking to Lagos (departure). No AUTHOR DETAIL NEEDED markers remain. Oral tradition framed as family memory throughout. Benin connection stated as oral inheritance, not certified history. Isua/Lagos/Osun distinctions preserved correctly. Acceptance gate: one sentence only Abraham could have written — "The road between Isua and Lagos is shorter now. The inheritance is not." One physical scene: the tailor meeting the missionary's cloth, needle, measurement — the first Christian decision in the lineage.*
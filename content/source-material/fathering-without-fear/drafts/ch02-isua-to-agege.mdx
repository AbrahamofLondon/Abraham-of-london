...
*Market-ready body pass. Scene architecture in four movements: (1) Isua and kingmaker lineage, (2) the name earned through wealth, (3) the missionary tailor encounter — the chapter's physical anchor, (4) unfinished inheritance. Tailoring detail resolved with author-supplied detail: agbada robes, charcoal pressing iron, son denied both on Abraham Adaramola's death. One AUTHOR DETAIL NEEDED remains for the departure detail (how he travelled from Isua to Lagos). Oral tradition framed as family memory throughout. Benin connection stated as oral inheritance, not certified history. Isua/Lagos/Osun distinctions preserved correctly. Acceptance gate: one sentence only Abraham could have written — "The road between Isua and Lagos is shorter now. The inheritance is not." One physical scene: the tailor meeting the missionary's cloth, needle, measurement — the first Christian decision in the lineage.*
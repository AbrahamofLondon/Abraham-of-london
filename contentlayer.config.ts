...
function withDefaults(
  ...
  const defaultedFields: typeof fields = {} as any;
...
export const Post = defineDocumentType(() => ({
  ...
  computedFields: {
    slug: {
      type: "string",
      resolve: (doc) =>
        (doc as any).slug || generateSlug(doc._raw.flattenedPath, "blog"),
    },
    url: {
      type: "string",
      resolve: (doc) =>
  ...
  computedFields: {
    ...
    downloadHref: {
      ...
      resolve: (doc) => {
        ...
        const candidate = d.pdfPath || d.downloadFile || d.file || "";
        if (!candidate) return "";
...
export const Book = defineDocumentType(() => ({
  ...
  computedFields: {
    slug: {
      type: "string",
      resolve: (doc) =>
        (doc as any).slug || generateSlug(doc._raw.flattenedPath, "books"),
    },
    url: {
      type: "string",
      resolve: (doc) =>
...
export const Event = defineDocumentType(() => ({
  ...
  computedFields: {
    slug: {
      type: "string",
      resolve: (doc) =>
        (doc as any).slug || generateSlug(doc._raw.flattenedPath, "events"),
    },
    url: {
      type: "string",
      resolve: (doc) =>
    ...
    isUpcoming: {
      ...
      resolve: (doc) => {
        const d = doc as any;
        const eventDate = new Date(d.eventDate || d.date);
...
export const Print = defineDocumentType(() => ({
  ...
  computedFields: {
    slug: {
      type: "string",
      resolve: (doc) =>
        (doc as any).slug || generateSlug(doc._raw.flattenedPath, "prints"),
    },
    url: {
      type: "string",
      resolve: (doc) =>
...
export const Strategy = defineDocumentType(() => ({
  ...
  computedFields: {
    slug: {
      type: "string",
      resolve: (doc) =>
        (doc as any).slug || generateSlug(doc._raw.flattenedPath, "strategy"),
    },
    url: {
      type: "string",
      resolve: (doc) =>
...
export const Canon = defineDocumentType(() => ({
  ...
  computedFields: {
    slug: {
      type: "string",
      resolve: (doc) =>
        (doc as any).slug || generateSlug(doc._raw.flattenedPath, "canon"),
    },
    url: {
      type: "string",
      resolve: (doc) =>

...
const EditorialSeriesPart = defineDocumentType(() => ({
  ...
  fields: {
    ...
    seriesDescription: { type: "string", required: false },
    seriesVisibility: { type: "string", required: false },
    /** Distinguishes editorial series from special-edition series. Values: "special-edition" */
    seriesKind: { type: "string", required: false },
  },
...
const Brief = defineDocumentType(() => ({
  ...
  fields: {
    ...
    editorialScore:    { type: "number", required: false },
    editorialCluster:  { type: "string", required: false },
    primaryRoute:      { type: "string", required: false },
    secondaryRoute:    { type: "string", required: false },
    relatedCanon:      { type: "string", required: false },
    innerCircleBridge: { type: "string", required: false },
  },
...
const VaultBrief = defineDocumentType(() => ({
  ...
  fields: {
    ...
    series: { type: "string", required: false },
    seriesOrder: { type: "number", required: false },
    // Publication release fields (shared with Brief for schema parity)
    publicationStatus: { type: "string", required: false },
    publishedAt:       { type: "string", required: false },
    scheduledFor:      { type: "string", required: false },
    season:            { type: "string", required: false },
    ...
    relatedCanon:      { type: "string", required: false },
    innerCircleBridge: { type: "string", required: false },
    riseDecayScore:    { type: "number", required: false },
    riseDecayTarget:   { type: "string", required: false },
    severityScore:     { type: "number", required: false },
    resilienceTarget:  { type: "string", required: false },
    primaryFracture:   { type: "string", required: false },
    failureMode:       { type: "string", required: false },
    prerequisites:     { type: "list", of: { type: "string" }, required: false },
    nextBrief:         { type: "string", required: false },
    relatedBriefs:     { type: "list", of: { type: "string" }, required: false },
    relatedTool:       { type: "string", required: false },
    implementationHorizon: { type: "string", required: false },
    kpis:              { type: "list", of: { type: "string" }, required: false },
    innerCircleCompanion: { type: "string", required: false },
  },

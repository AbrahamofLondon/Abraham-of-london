...
export default function ContactEmail({ name, email, message }: Props) {
  return (
    <Html>
      ...
      <Body style={{ backgroundColor: '#f6f6f6', fontFamily: 'system-ui, -apple-system, Segoe UI, Roboto, Arial' }}>
        <Container style={{ margin: '24px auto', padding: '24px', background: '#fff', borderRadius: 12, maxWidth: 560 }}>
          <Section>
            ...
            <Text style={{ whiteSpace: 'pre-wrap', color: '#0d1b2a' }}>{message}</Text>

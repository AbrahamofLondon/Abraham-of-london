...
export const ADMIN_NAVIGATION: AdminNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "gmi-control-plane", label: "GMI Control Plane", href: "/admin/intelligence/gmi-control-plane", router: "pages", visibility: "admin", status: "active", description: "GMI publication safety, trust, source, falsification, consequence, and commercial routing gate" },
      ...
      { id: "gmi-call-review", label: "GMI Call Review", href: "/admin/intelligence/gmi-call-review", router: "pages", visibility: "admin", status: "active", description: "Governed Global Market Intelligence call review workflow and locked rubric" },
      { id: "gmi-falsification", label: "GMI Falsification", href: "/admin/intelligence/gmi-falsification", router: "pages", visibility: "admin", status: "active", description: "GMI falsification threshold registry and thesis review queue" },
      { id: "gmi-red-team", label: "GMI Red Team", href: "/admin/intelligence/gmi-red-team", router: "pages", visibility: "admin", status: "active", description: "Review queue for Global Market Intelligence red-team challenges" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "feedback", label: "Feedback Intelligence", href: "/admin/feedback", router: "pages", visibility: "admin", status: "active", description: "Governed product feedback: quality review, falsification, case-study, sales, and pattern signals" },
  ...
  },
  {
    ...
    items: [
      { id: "estate-fulfilment", label: "Estate Fulfilment", href: "/admin/fulfilment", router: "pages", visibility: "admin", status: "active", description: "Unified estate-wide fulfilment queue: all paid, governed, and review-requiring items across every product" },
      { id: "product-fulfilment-matrix", label: "Product Fulfilment Matrix", href: "/admin/product-fulfilment", router: "pages", visibility: "admin", status: "active", description: "Readiness status (GREEN/AMBER/RED/GREY) for every product in the estate — contracts, hard failures, warnings" },
      { id: "operations", label: "Jobs & Operations", href: "/admin/operations", router: "pages", visibility: "admin", status: "active", description: "Background job triggers: diagnostic processing and retention sweep" },

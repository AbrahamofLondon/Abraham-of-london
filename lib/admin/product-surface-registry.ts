...
export const PRODUCT_SURFACE_REGISTRY: AdminProductSurface[] = [
  ...
  },
  {
    ...
    status: "live",
    audience: "sponsor",
    entryRequirement: "Returning governed case / authenticated user console. At least one completed diagnostic or assessment.",
    captures: [
      "Decision velocity data",
      "Checkpoint status",
      "Active cases",
      "Cost of delay estimates",
      "Escalation readiness indicators",
    ],
    outputs: [
      "Active case state summary",
      "Checkpoint queue with next actions",
  ...
  // ── CLIENT PORTAL ────────────────────────────────────────────────────────
  {
    ...
    outputs: [
      ...
      "What changed / did not change / now required record",
    ],
    downstream: [
      "Oversight",
    ],
  ...
  // ── CONTENT ──────────────────────────────────────────────────────────────
  {
    ...
    status: "live",
    audience: "sponsor",
    entryRequirement: "Completed diagnostic with approved evidence. Case must have sufficient history.",
    captures: [
      "Evidence posture records",
      "Review state data",
      "Delivery/outcome records",
      "Provenance cues",
    ],
    outputs: [
      "Portable client-safe proof pack",
      "Governed chain summary",
  ...
  // ── PUBLIC / CLIENT TOOLS ────────────────────────────────────────────────
  {
    id: "decision-delay-exposure-calculator",
    label: "Decision Delay Exposure Calculator",
    category: "DIAGNOSTIC",
    clientRoute: "/tools/decision-delay-exposure",
    status: "live",
    audience: "individual",
    entryRequirement: "None — public entry surface. No account required.",
    captures: [
      "Weekly cost input (user-provided)",
      "Delay window (user-provided)",
      "Exposure type selection",
    ],
    outputs: [
      "7/30/90-day scenario exposure estimates",
      "Exposure assessment statement",
      "Structural consequence description",
  ...
  {
    id: "board-summary-preview",
    label: "Board Summary Preview",
    category: "DIAGNOSTIC",
    clientRoute: "/diagnostics/board-summary",
    status: "live",
    audience: "individual",
    entryRequirement: "Fast Diagnostic completion with session data available.",
    captures: [
    ...
    outputs: [
      ...
      "Scenario-bound consequence display",
      "Next-layer navigation route",
    ],
    downstream: [
      "Executive Reporting",
      "Decision Centre",
  ...
  {
    id: "provenance-sample-export",
    label: "Provenance Sample Export",
    category: "CONTENT",
    clientRoute: "/provenance/sample-export",
    status: "live",
    audience: "individual",
    entryRequirement: "None — public sample page. No account required.",
    captures: [],
    outputs: [
      "Client-safe provenance sample",
      "Accountability statement",
      "Hash continuity display",
      "Confidence bands",
      "Milestone timeline",
      "Boundary notes",
    ],
  ...
  {
    id: "public-anchor-log",
    label: "Public Anchor Log",
    category: "CONTENT",
    clientRoute: "/provenance/anchor-log",
    status: "live",
    audience: "individual",
    entryRequirement: "None — public anchor root log. No account required.",
    captures: [],
    outputs: [
      "Cryptographic Merkle root display",
      "Anchor version and scope",
      "Leaf count and computation timestamp",
    ],
    downstream: [],
    monitoringPriority: "low",
    operationalOwner: "admin",

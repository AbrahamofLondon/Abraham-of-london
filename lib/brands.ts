// pages/brands.tsx (FINAL — drop-in)
...
const BRANDS = [
  {
    ...
    url: "/ventures?brand=innovatehub",
...
// Parallax (SSR-safe; hooks return inert values on server)
...
export default function BrandsPage() {
  ...
  // sameAs for JSON-LD (sanitized + deduped)
        ...
        <div className="container relative z-10 mx-auto max-w-6xl px-4">
          ...
          >
            <div className="relative z-10 flex flex-col items-center gap-8 md:flex-row md:gap-12">
              ...
              >
                <h1 className="mb-3 text-4xl font-serif font-bold text-deepCharcoal md:text-5xl">
                  Abraham of London
                </h1>
          ...
          <section className="mb-16">
            <h2 className="mb-12 text-center text-4xl font-serif font-bold text-deepCharcoal md:text-5xl">
              Our Ventures
            </h2>
            <motion.div
                ...
                return (
                  ...
                  >
                    {brand.url.startsWith("/") ? (
                      <Link href={brand.url} className="block" prefetch={false} aria-label={`Visit ${brand.name}`}>
                        {CardInner}
                      </Link>
                    ) : (
                      <a

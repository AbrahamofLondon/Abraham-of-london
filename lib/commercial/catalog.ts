...
export const CATALOG: Record<string, CatalogProduct> = {
  ...
  execution_integrity_protocol: {
    ...
    requiresCheckout: true,
    includes: [],
    shortDescription: "Restore execution discipline without rewriting strategy. Governed methodology run. Writes to Decision Centre memory.",
  ...
  alignment_audit_playbook: {
    ...
    requiresCheckout: true,
    includes: [],
    shortDescription: "Diagnose organisational misalignment before intervention. Governed methodology run. Writes to Decision Centre memory.",
    primaryCta: "Get access — £49",
    deliveryFormat: "governed_methodology_run",
    estimatedCompletionMinutes: 20,
    writesToDecisionMemory: true,
  ...
  drift_detection_framework: {
    ...
    requiresCheckout: true,
    includes: [],
    shortDescription: "Identify silent organisational decay before it becomes structural failure. Governed methodology run. Writes to Decision Centre memory.",

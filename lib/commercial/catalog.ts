...
export const CATALOG: Record<string, CatalogProduct> = {
  ...
  boardroom_brief: {
    ...
    amount: 9900,
    displayPrice: "£99",
    stripeProductId: "prod_UctSn3zRH48xmw",
    ...
    pricingNote: "Starter proof-of-value path.",
  ...
  decision_exposure_instrument: {
    ...
    amount: 2900,
    displayPrice: "\u00a329",
    stripeProductId: "prod_UNn7ap08YthbzX",
  ...
  mandate_clarity_framework: {
    ...
    amount: 4900,
    displayPrice: "\u00a349",
    stripeProductId: "prod_UNn91TpI2bVoq2",
  ...
  intervention_path_selector: {
    ...
    amount: 7900,
    displayPrice: "\u00a379",
    stripeProductId: "prod_UNnD90NG5bjNwW",
  ...
  strategic_priority_stack_builder: {
    ...
    cookieName: null,
    includes: [],
    shortDescription: "Convert competing priorities into a ranked stack with conflict detection.",
    deliveryFormat: "interactive_instrument",
    estimatedCompletionMinutes: 15,
    writesToDecisionMemory: true,
    dossierEligible: true,
  ...
  execution_integrity_protocol: {
    ...
    requiresCheckout: true,
    includes: [],
    shortDescription: "Restore execution discipline without rewriting strategy. Writes to Decision Centre memory.",
    primaryCta: "Get access — £49",
  ...
  alignment_audit_playbook: {
    ...
    requiresCheckout: true,
    includes: [],
    shortDescription: "Diagnose organisational misalignment before intervention. Writes to Decision Centre memory.",
    primaryCta: "Get access — £49",
    deliveryFormat: "governed_methodology_run",
    estimatedCompletionMinutes: 20,
    writesToDecisionMemory: true,
  ...
  drift_detection_framework: {
    ...
    requiresCheckout: true,
    includes: [],
    shortDescription: "Identify silent organisational decay before it becomes structural failure. Writes to Decision Centre memory.",
    primaryCta: "Get access — £39",
    deliveryFormat: "governed_methodology_run",
    estimatedCompletionMinutes: 12,
    writesToDecisionMemory: true,
    dossierEligible: true,
  ...
  operator_decision_pack: {
    ...
    amount: 12900,
    displayPrice: "\u00a3129",
    stripeProductId: "prod_UNnJnBbtJB1qP0",
  ...
  boardroom_mode: {
    ...
    cookieName: null,
    includes: [],
    shortDescription: "Adversarial challenge for executive decisions. Requires prior Executive Reporting or case record.",
    userPromise: "Tests decision robustness under contrary evidence, hidden dependencies, and objections a board will raise.",
    pricingNote: "Evidence-gated — no self-serve checkout. Access requires prior case record.",
  ...
  professional: {
    ...
    cookieName: null,
    includes: [],
    shortDescription: "The continuity layer: unlimited active cases, Return Brief generation, client-safe evidence export, client-safe reviewer links, and organisation workspace.",
    userPromise: "Preserve continuity across active cases. Keep new cases moving and unlock Return Brief generation, client-safe evidence export, reviewer links, and organisation collaboration.",
    pricingNote: "Professional is the continuity layer for ongoing case work.",
  ...
  enterprise: {
    ...
    userPromise: "Enterprise-grade decision support infrastructure. Annual custom plan with organisation workspace, seat management, and dedicated support.",
  ...
  additional_collaborator: {
    ...
    stripePriceId: "price_1TXt28QFpelVFMXJCqiXwnxp",
    ...
    userPromise: "Add collaborators as your case load grows. Additional collaborator billing is currently handled manually.",

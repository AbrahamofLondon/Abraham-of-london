...
export const CATALOG: Record<string, CatalogProduct> = {
  ...
  professional: {
    ...
    cookieName: null,
    includes: [],
    shortDescription: "Unlimited active governed cases, Return Brief generation, client-safe evidence export, and organisation workspace.",
    userPromise: "Keep governing new active cases without limits. Unlock Return Brief generation, client-safe evidence export, and organisation collaboration.",

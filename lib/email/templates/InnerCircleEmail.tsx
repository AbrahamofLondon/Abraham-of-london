    ...
    <EmailHtml lang="en">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>To activate your access, click the link below:</Text>
          ...
          <Text style={footer}>
            {isResend
              ? "This link was resent at your request. If you did not request a new link, contact support immediately."

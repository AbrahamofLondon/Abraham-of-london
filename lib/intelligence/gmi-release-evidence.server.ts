...
// client fallback both handle them. This module is server-only (.server.ts,
// reached only from getServerSideProps/API server paths); the "node:" scheme
// slips past webpack externalization inside dynamic-import chunks and triggers
// UnhandledSchemeError. Logic is unchanged — same createHash/fs/path behaviour.

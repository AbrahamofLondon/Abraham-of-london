...
export const GMI_Q2_2026_SOURCE_APPENDIX_ROWS: readonly GmiSourceAppendixRow[] = [
  {
    ...
    claim: "Global growth institutional forecasts have dispersed to ~2.5–3.1% (widening spread, not consensus)",
    evidenceClass: "INSTITUTIONAL_SOURCE",
    confidenceBasis: "institutionally_sourced",
    sourceOrBasis: "IMF World Economic Outlook, April 2026 (3.1% projection); OECD Economic Outlook, June 2026 (2.8%); World Bank Global Economic Prospects, June 2026 (2.5%); Goldman Sachs release-lock forecast value (2.8%; no retained dated source establishes the earlier 2.9% figure)",
    observationWindow: "Q1-Q2 2026",
    confidence: "MEDIUM",
    reportSection: "Global Macro Snapshot",
    status: "VERIFIED",
    releaseBlocker: false,
    methodNote: "Dispersion range derived from IMF WEO April 2026 (3.1%), OECD June 2026 (2.8%), World Bank June 2026 (2.5%), and Goldman Sachs release-lock value (2.8%). The strategic signal is the widening spread across institutions — reflecting divergent assumptions on tariff duration and financial spillovers — not any single point estimate. Methodologies differ and are not directly comparable; Morgan Stanley is excluded because no release-grade source is retained for this ledger.",
  },
  {
    id: "GMI-Q2-SRC-002",
    reportId: "GMI-Q2-2026",

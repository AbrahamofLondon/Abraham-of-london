...
export const ADMIN_ROUTES: AdminRouteEntry[] = [
  ...
  { route: "/admin/fulfilment", domain: "product-operations", requiredRole: "ADMIN", canonicalRecord: "EstateFulfilmentSpine", riskLevel: "HIGH", emitsAudit: false },
  { route: "/admin/product-fulfilment", domain: "product-operations", requiredRole: "ADMIN", productSurface: "product-estate", canonicalRecord: "ProductFulfilmentContract", riskLevel: "LOW", emitsAudit: false },

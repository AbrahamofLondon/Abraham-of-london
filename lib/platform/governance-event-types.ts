...
export const GOVERNANCE_EVENT_TYPES: EventTypeEntry[] = [
  ...
  // ── Foundry Promotion ───────────────────────────────────────────────────
  // SIMULATION_ONLY: promotion audit events are written to foundryAuditEvent table;
  // governance bus wiring is pending.
  { eventType: "FOUNDRY_PROMOTION_CREATED", description: "Foundry module maturity promotion recorded", sourceSurface: "foundry", canonicalRecordType: "ResearchRun", defaultSeverity: "MEDIUM", writesAudit: true, writesLineage: true, canCreateResearchRun: false, adminDomain: "foundry", maturity: "SIMULATION_ONLY", currentReality: "simulation", targetMaturity: "LIVE_GOVERNED", promotionCriteria: ["Wire governance bus emitter in promotion-service.ts", "Persist to GovernanceEvent table in addition to FoundryAuditEvent"], blockingGaps: ["Promotion events written to foundryAuditEvent only; governance bus wiring pending"], foundryRelationship: "generates", affectsProductHealth: false, appearsInDashboards: false },
  { eventType: "FOUNDRY_PROMOTION_ROLLED_BACK", description: "Foundry module maturity promotion rolled back (append-only record)", sourceSurface: "foundry", canonicalRecordType: "ResearchRun", defaultSeverity: "HIGH", writesAudit: true, writesLineage: true, canCreateResearchRun: true, adminDomain: "foundry", maturity: "SIMULATION_ONLY", currentReality: "simulation", targetMaturity: "LIVE_GOVERNED", promotionCriteria: ["Wire governance bus emitter in rollback route"], blockingGaps: ["Rollback events written to foundryAuditEvent only; governance bus wiring pending"], foundryRelationship: "generates", affectsProductHealth: false, appearsInDashboards: false },
  { eventType: "FOUNDRY_RUN_STATUS_CHANGED", description: "Foundry ResearchRun status transitioned (e.g. PENDING → IMPLEMENTED)", sourceSurface: "foundry", canonicalRecordType: "ResearchRun", defaultSeverity: "LOW", writesAudit: true, writesLineage: true, canCreateResearchRun: false, adminDomain: "foundry", maturity: "SIMULATION_ONLY", currentReality: "simulation", targetMaturity: "LIVE_GOVERNED", promotionCriteria: ["Wire governance bus emitter in ResearchRunRepository transition methods"], blockingGaps: ["Status changes written to foundryAuditEvent only; governance bus wiring pending"], foundryRelationship: "generates", affectsProductHealth: false, appearsInDashboards: false },

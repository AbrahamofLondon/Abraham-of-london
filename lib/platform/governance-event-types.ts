...
export const GOVERNANCE_EVENT_TYPES: EventTypeEntry[] = [
  ...
  // LIVE_GOVERNED: Boardroom Brief delivery pipeline audit events — governed state machine transitions
  { eventType: "BOARDROOM_ORDER_PAID", description: "Boardroom Brief order payment confirmed", sourceSurface: "boardroom-mode", canonicalRecordType: "BoardroomBriefOrder", defaultSeverity: "HIGH", writesAudit: true, writesLineage: true, canCreateResearchRun: false, adminDomain: "product-operations", maturity: "LIVE_GOVERNED", currentReality: "real", affectsProductHealth: true, appearsInDashboards: true },
  { eventType: "BOARDROOM_CASE_STUBS_CREATED", description: "Boardroom Brief fulfilment stubs created (ProductArtifact, FalsificationEntry, OutcomeHypothesis)", sourceSurface: "boardroom-mode", canonicalRecordType: "BoardroomBriefOrder", defaultSeverity: "MEDIUM", writesAudit: true, writesLineage: true, canCreateResearchRun: false, adminDomain: "product-operations", maturity: "LIVE_GOVERNED", currentReality: "real", affectsProductHealth: true, appearsInDashboards: true },
  { eventType: "BOARDROOM_DRAFT_GENERATED", description: "Boardroom Brief dossier draft generated from paid order", sourceSurface: "boardroom-mode", canonicalRecordType: "BoardroomBriefOrder", defaultSeverity: "HIGH", writesAudit: true, writesLineage: true, canCreateResearchRun: false, adminDomain: "product-operations", maturity: "LIVE_GOVERNED", currentReality: "real", affectsProductHealth: true, appearsInDashboards: true },
  { eventType: "BOARDROOM_OPERATOR_REVIEW_STARTED", description: "Boardroom Brief operator review started", sourceSurface: "boardroom-mode", canonicalRecordType: "BoardroomBriefOrder", defaultSeverity: "MEDIUM", writesAudit: true, writesLineage: true, canCreateResearchRun: false, adminDomain: "product-operations", maturity: "LIVE_GOVERNED", currentReality: "real", affectsProductHealth: true, appearsInDashboards: true },
  { eventType: "BOARDROOM_DRAFT_APPROVED", description: "Boardroom Brief draft approved for delivery by admin", sourceSurface: "boardroom-mode", canonicalRecordType: "BoardroomBriefOrder", defaultSeverity: "HIGH", writesAudit: true, writesLineage: true, canCreateResearchRun: false, adminDomain: "product-operations", maturity: "LIVE_GOVERNED", currentReality: "real", affectsProductHealth: true, appearsInDashboards: true },
  { eventType: "BOARDROOM_CUSTOMER_ACCESS_CREATED", description: "Boardroom Brief customer access link created", sourceSurface: "boardroom-mode", canonicalRecordType: "BoardroomBriefOrder", defaultSeverity: "HIGH", writesAudit: true, writesLineage: true, canCreateResearchRun: false, adminDomain: "product-operations", maturity: "LIVE_GOVERNED", currentReality: "real", affectsProductHealth: true, appearsInDashboards: true },
  { eventType: "BOARDROOM_DELIVERED", description: "Boardroom Brief delivered to customer", sourceSurface: "boardroom-mode", canonicalRecordType: "BoardroomBriefOrder", defaultSeverity: "HIGH", writesAudit: true, writesLineage: true, canCreateResearchRun: false, adminDomain: "product-operations", maturity: "LIVE_GOVERNED", currentReality: "real", affectsProductHealth: true, appearsInDashboards: true },
  { eventType: "BOARDROOM_DELIVERY_FAILED", description: "Boardroom Brief delivery failed", sourceSurface: "boardroom-mode", canonicalRecordType: "BoardroomBriefOrder", defaultSeverity: "HIGH", writesAudit: true, writesLineage: true, canCreateResearchRun: false, adminDomain: "product-operations", maturity: "LIVE_GOVERNED", currentReality: "real", affectsProductHealth: true, appearsInDashboards: true },
  { eventType: "BOARDROOM_DELIVERY_BLOCKED", description: "Boardroom Brief delivery blocked", sourceSurface: "boardroom-mode", canonicalRecordType: "BoardroomBriefOrder", defaultSeverity: "HIGH", writesAudit: true, writesLineage: true, canCreateResearchRun: false, adminDomain: "product-operations", maturity: "LIVE_GOVERNED", currentReality: "real", affectsProductHealth: true, appearsInDashboards: true },

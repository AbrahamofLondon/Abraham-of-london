...
export const GOVERNANCE_EVENT_TYPES: EventTypeEntry[] = [
  ...
  { eventType: "FOUNDRY_PROMOTION_CREATED", description: "Foundry module maturity promotion recorded — writes FoundryPromotion row, updates ResearchRun.maturityStage, emits FoundryAuditEvent", sourceSurface: "foundry", canonicalRecordType: "ResearchRun", defaultSeverity: "MEDIUM", writesAudit: true, writesLineage: true, canCreateResearchRun: false, adminDomain: "foundry", maturity: "PILOT_READY", currentReality: "controlled", targetMaturity: "LIVE_GOVERNED", promotionCriteria: ["Wire standalone GovernanceEvent table emitter", "Expose promotion events in admin audit log surface", "Prove recovery path for failed DB write mid-transaction"], blockingGaps: ["Governance bus not wired separately; events queryable via FoundryAuditEvent only"], foundryRelationship: "generates", affectsProductHealth: false, appearsInDashboards: false },
  { eventType: "FOUNDRY_PROMOTION_ROLLED_BACK", description: "Foundry module maturity promotion rolled back — append-only FoundryPromotion update + FoundryAuditEvent", sourceSurface: "foundry", canonicalRecordType: "ResearchRun", defaultSeverity: "HIGH", writesAudit: true, writesLineage: true, canCreateResearchRun: true, adminDomain: "foundry", maturity: "PILOT_READY", currentReality: "controlled", targetMaturity: "LIVE_GOVERNED", promotionCriteria: ["Wire governance bus emitter in rollback route", "Add rollbackBy field to FoundryPromotion"], blockingGaps: ["rollbackBy actor not persisted to schema; governance bus wiring pending"], foundryRelationship: "generates", affectsProductHealth: false, appearsInDashboards: false },
  { eventType: "FOUNDRY_RUN_STATUS_CHANGED", description: "Foundry ResearchRun status transitioned — updates maturityStage, emits FoundryAuditEvent", sourceSurface: "foundry", canonicalRecordType: "ResearchRun", defaultSeverity: "LOW", writesAudit: true, writesLineage: true, canCreateResearchRun: false, adminDomain: "foundry", maturity: "PILOT_READY", currentReality: "controlled", targetMaturity: "LIVE_GOVERNED", promotionCriteria: ["Wire governance bus emitter in ResearchRunRepository transition methods", "Expose status timeline in run detail"], blockingGaps: ["Governance bus not wired separately; status history queryable via FoundryAuditEvent only"], foundryRelationship: "generates", affectsProductHealth: false, appearsInDashboards: false },

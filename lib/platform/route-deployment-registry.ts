...
export const ROUTE_REGISTRY: RouteEntry[] = [
  ...
  {
    path: "/admin/intelligence-foundry/living-case-fulfilment",
    class: "ADMIN_DYNAMIC",
    owner: "intelligence",
    intent: "Living case fulfilment admin view for inspecting case lifecycle and engine event history",
    deployable: true,
    requiresAuth: true,
    requiresDatabase: true,
    requiresRuntime: "nodejs",
  ...
  {
    path: "/foundry/case/success",
    class: "ADMIN_DYNAMIC",
    owner: "intelligence",
    intent: "Foundry case submission success confirmation page",
    deployable: true,
    requiresAuth: false,
    requiresDatabase: false,
    requiresRuntime: "nodejs",
  ...
  {
    path: "/admin/product-estate",
    class: "ADMIN_DYNAMIC",
    owner: "product",
    intent: "Product estate command centre — admin-only overview of all products, entitlements, and catalog integrity",
    deployable: true,
    requiresAuth: true,
    requiresDatabase: true,
    requiresRuntime: "nodejs",
  ...
  },
  {
    ...
    class: "CLIENT_DELIVERY",
    owner: "product",
    intent: "Account instrument history — user's paid instrument run log, artifact downloads, and outcome tracking",
    deployable: true,
    requiresAuth: true,
    requiresDatabase: true,
    requiresRuntime: "nodejs",

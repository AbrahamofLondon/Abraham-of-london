...
export const CAPABILITY_STATUS_RECORDS: CapabilityRecord[] = [
  ...
  },
  {
    ...
    filePath: 'pages/boardroom-brief.tsx',
    productLine: 'OPERATIONAL_DECISION_INTELLIGENCE',
    layer: 'UI_SURFACE',
    status: 'ACTIVE',
    usedBy: ['lib/constitution/boardroom-spine-builder.ts', 'lib/constitution/boardroom-mode.ts'],
    outputDestination: ['/boardroom-brief page route', '/api/billing/checkout via boardroom_brief catalog product'],
    outputProduced: ['Boardroom-style decision brief from single intake', 'sample brief route', 'qualified/refusal states for thin evidence', 'paid Boardroom Brief checkout CTA'],
    dataRequired: ['decision', 'consequence', 'evidenceAvailable minimum thresholds'],
    recommendation: 'Keep as market activation/front-door surface. Do not treat as Executive Reporting or full Boardroom Mode.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {
    capabilityId: 'Products Page',
    filePath: 'pages/products.tsx',
    productLine: 'COMMERCIAL_GROWTH',
    layer: 'COMMERCIAL',
    status: 'ACTIVE',
    outputDestination: ['/products page route'],
    outputProduced: ['buyer-intent routing', 'product family routing', 'gated/planned/access boundaries'],
    recommendation: 'Keep as buyer router; pricing remains payment/access.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {
    capabilityId: 'Decision Pressure Signal',
    filePath: 'pages/decision-pressure.tsx',
    productLine: 'COMMERCIAL_GROWTH',
    layer: 'CAPTURE',
    status: 'ACTIVE',
    outputDestination: ['/decision-pressure page route'],
    outputProduced: ['Green/Amber/Red pressure band', 'missing evidence', 'authority or ownership risk', 'delay risk', 'next admissible move', 'Boardroom Brief CTA'],
    recommendation: 'Keep free signal compact and route serious pressure into Boardroom Brief.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {
    capabilityId: 'Enterprise Landing',
    filePath: 'pages/enterprise.tsx',
    productLine: 'COMMERCIAL_GROWTH',
    layer: 'COMMERCIAL',
    status: 'ACTIVE',
    outputDestination: ['/enterprise page route'],
    outputProduced: ['organisation buyer positioning', 'enterprise pathway routing', 'cost-of-delay hook', 'enterprise scan CTA'],
    recommendation: 'Keep /enterprise distinct from /enterprise-decision-scan assessment tool.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {
    capabilityId: 'Enterprise Cost-of-Delay Hook',
    filePath: 'pages/enterprise.tsx',
    productLine: 'COMMERCIAL_GROWTH',
    layer: 'COMMERCIAL',
    status: 'ACTIVE',
    outputDestination: ['/enterprise Cost of delay section'],
    outputProduced: ['estimated monthly decision exposure', 'total delay exposure', 'financial forecast disclaimer', 'organisational scan CTA'],
    recommendation: 'Do not persist sensitive financial inputs without explicit persistence requirements.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {
    capabilityId: 'Professionals Page',
    filePath: 'pages/professionals.tsx',
    productLine: 'COMMERCIAL_GROWTH',
    layer: 'COMMERCIAL',
    status: 'ACTIVE',
    outputDestination: ['/professionals page route'],
    outputProduced: ['referral-first professional positioning', 'professional access request route', 'Boardroom Brief CTA'],
    recommendation: 'Keep selective; do not promise automated commissions, dashboards, or white-labelling.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {
  ...
  // ── Cashflow Activation Sprint — surfaces confirmed ACTIVE ────────────────
  {
    capabilityId: 'Decision Pressure Signal Page',
    filePath: 'pages/decision-pressure.tsx',
    productLine: 'OPERATIONAL_DECISION_INTELLIGENCE',
    layer: 'CAPTURE',
    status: 'ACTIVE',
    usedBy: ['pages/test-your-decision.tsx', 'pages/products.tsx'],
    outputDestination: ['Free signal result: pressure band, missing evidence, next admissible move'],
    outputProduced: ['PressureSignal: band (Green/Amber/Red), bandReason, missingEvidence, authorityOwnershipRisk, consequenceDelayRisk, nextAdmissibleMove, compactSummary'],
    recommendation: 'Routes to /boardroom-brief after result. Keep refusal as a feature.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {
    capabilityId: 'Enterprise Landing Page',
    filePath: 'pages/enterprise.tsx',
    productLine: 'OPERATIONAL_DECISION_INTELLIGENCE',
    layer: 'UI_SURFACE',
    status: 'ACTIVE',
    corridorStage: 'enterprise_assessment',
    usedBy: ['pages/products.tsx'],
    outputDestination: ['Enterprise commercial landing with cost-of-delay hook'],
    outputProduced: ['Cost-of-delay estimate (directional only, clearly qualified), pathway to /enterprise-decision-scan'],
    recommendation: 'Does not store financial inputs. Does not claim financial advice.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {
    capabilityId: 'Enterprise Cost-of-Delay Hook',
    ...
    status: 'ACTIVE',
    corridorStage: 'enterprise_assessment',
    outputDestination: ['Inline directional pressure check before enterprise scan CTA'],
    outputProduced: ['estimatedMonthlyDecisionExposure, totalDelayExposure with qualified disclaimer'],
    dataRequired: ['monthlyExposure (£), deteriorationProbability (%), delayPeriod (months)'],
    recommendation: 'Keep clearly qualified: "This is an estimate, not a financial forecast."',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {
    capabilityId: 'Professionals Page',
    ...
    status: 'ACTIVE',
    usedBy: ['pages/products.tsx'],
    outputDestination: ['Referral-first professional access page'],
    outputProduced: ['Professional access request CTA, client use case routes, boundary copy (selective, no white-labelling, no automated commission)'],
    recommendation: 'Selective opening only. No full partner portal yet.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {
    capabilityId: 'Products Directory Page',
    filePath: 'pages/products.tsx',
    productLine: 'OPERATIONAL_DECISION_INTELLIGENCE',
    layer: 'UI_SURFACE',
    status: 'ACTIVE',
    usedBy: ['pages/index.tsx', 'components/homepage/CategoryFrontDoor.tsx'],
    outputDestination: ['Commercial routing layer for Decision Infrastructure product estate'],
    outputProduced: ['Buyer-intent routing, pressure signal prominence, Boardroom Brief feature block, paid corridor rail, status badges, collapsed secondary sections'],
    recommendation: 'Keep /pricing as payment/access page. /products routes intent; it does not replace /pricing.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {

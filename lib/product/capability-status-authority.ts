...
export const CAPABILITY_STATUS_RECORDS: CapabilityRecord[] = [
  ...
  },
  {
    ...
    outputDestination: ['/boardroom-brief page route'],
    outputProduced: ['Boardroom-style decision brief from single intake', 'qualified/refusal states for thin evidence'],
    dataRequired: ['decision', 'consequence', 'evidenceAvailable minimum thresholds'],
    gatingReason: 'Route renders and dossier generation works, but no payment/export exists. Not a paid corridor stage — it is an activation/front-door surface.',
    recommendation: 'Add sample Boardroom brief endpoint and Decision Health Check before marking ACTIVE.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {

...
export const CAPABILITY_STATUS_RECORDS: CapabilityRecord[] = [
  ...
  },
  {
    ...
    outputDestination: ['boardroom archive records when called'],
    outputProduced: ['boardroom challenge archive summaries'],
    gatingReason: 'Archive assets exist, but durable boardroom mode production history is not fully established.',
    recommendation: 'Connect archive persistence to boardroom sessions before claiming longitudinal scrutiny history.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {
    ...
    gatingReason: 'Simulation adapter exists; production boardroom archive/session loop remains separate.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {
  ...
  },
  {
    ...
    outputDestination: ['recommendation outcome ledger'],
    outputProduced: ['recommendation and outcome records'],
    gatingReason: 'Ledger exists, but retained oversight memory threshold and complete execution loop are not proven here.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {
  ...
  },
  {
    ...
    status: 'GATED',
    corridorStage: 'retainer_oversight',
    dataRequired: ['review cycle evidence', 'prior recommendations', 'outcome verification'],
    gatingReason: 'Requires durable recommendation/outcome memory before automating review decisions.',
    lastVerifiedCommit: VERIFIED_COMMIT,
  },
  {

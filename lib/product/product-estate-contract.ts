...
export const PRODUCT_ESTATE: ProductEstateItem[] = [
...

  {
    ...
    shortDescription: 'Current published quarterly market intelligence until Q2 receives release authority.',
  ...
  },
  {
    ...
    buyerDescription: 'Fragmentation Under Shock: quarterly decision intelligence that remembers what it said, scores what happened, admits what changed, and turns uncertainty into governed decisions. Structurally ready; release authority remains pending.',

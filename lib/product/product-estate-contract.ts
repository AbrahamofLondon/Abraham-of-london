...
export const PRODUCT_ESTATE: ProductEstateItem[] = [
...

  {
    ...
    priceLabel: getProductDisplayPrice('boardroom_brief'),
...

  {
    ...
    priceLabel: getProductDisplayPrice('strategy_room_extended'),
...

  {
    ...
    priceLabel: getProductDisplayPrice('executive_reporting'),
...

  {
    ...
    priceLabel: getProductDisplayPrice('professional'),
...

  {
    ...
    priceLabel: getProductDisplayPrice('strategy_room'),
    primaryCTA: 'View Strategy Room',
    governed: true,
    live: true,
    purchasable: true,
...

  {
    ...
    priceLabel: getProductDisplayPrice('decision_exposure_instrument'),
...

  {
    ...
    priceLabel: getProductDisplayPrice('mandate_clarity_framework'),
    primaryCTA: 'Open instrument',
    governed: true,
    live: true,
    purchasable: true,
...

  {
    ...
    priceLabel: getProductDisplayPrice('intervention_path_selector'),
    primaryCTA: 'Open instrument',
    governed: true,
    live: true,
    purchasable: true,
...

  {
    ...
    priceLabel: getProductDisplayPrice('escalation_readiness_scorecard'),
    primaryCTA: 'Open instrument',
    governed: true,
    live: true,
    purchasable: true,
...

  {
    ...
    priceLabel: getProductDisplayPrice('board_brief_builder'),
    primaryCTA: 'Open instrument',
    governed: true,
    live: true,
    purchasable: true,
...

  {
    ...
    priceLabel: getProductDisplayPrice('drift_detection_framework'),
    primaryCTA: 'Request access',
    governed: true,
    live: true,
    purchasable: false,
...

  {
    ...
    shortDescription: 'Superseded quarterly edition, retained for historical access and the public call-scoring record.',
    buyerDescription: 'Q1 2026 coverage was superseded by GMI-Q2-2026 on 2026-07-08 through the governed release lifecycle. It remains available for historical reference and anchors the scored prior-call record reviewed in the Q2 edition.',
    availability: 'inactive',
    route: '/artifacts/global-market-intelligence-report-q1-2026',
    checkoutProductCode: 'gmi_q1_2026',
    priceLabel: getProductDisplayPrice('gmi_q1_2026'),
    primaryCTA: 'View archive',
    governed: true,
    live: true,
    purchasable: false,
    gatedReason: 'Superseded by GMI-Q2-2026 on 2026-07-08; retained for historical access.',
    shouldAppearOnProducts: true,
    shouldAppearOnPricing: false,
    relatedItems: ['gmi_q2_2026'],
  },
  {
    id: 'gmi_q2_2026',
    family: 'market_intelligence',
    name: 'Global Market Intelligence — Q2 2026',
    shortDescription: 'Current published quarterly decision intelligence — evidence-locked and released 2026-07-08.',
    buyerDescription: 'Fragmentation Under Shock: quarterly decision intelligence that remembers what it said, scores what happened, admits what changed, reviews prior calls, and turns unresolved market conditions into governed decisions. Released with a hash-bound evidence lock, scored prior-call review, and owner release authority.',
    availability: 'paid',
    route: '/offers/global-market-intelligence-q2',
    checkoutProductCode: 'gmi_q2_2026',
    priceLabel: getProductDisplayPrice('gmi_q2_2026'),
    primaryCTA: 'Request access',
    governed: true,
    live: true,
    purchasable: true,

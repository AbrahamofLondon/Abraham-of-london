...
export const PRODUCT_ESTATE: ProductEstateItem[] = [
...

  {
    ...
    shortDescription: 'Current published quarterly market intelligence with prior-call review until Q2 receives release authority.',
    buyerDescription: 'Q1 2026 coverage remains the current published GMI edition until Q2 completes the final post-8-July data lock and owner release authority.',
    availability: 'paid',
  ...
  },
  {
    ...
    shortDescription: 'Market-ready quarterly decision intelligence release candidate awaiting final data lock.',
    buyerDescription: 'Fragmentation Under Shock: quarterly decision intelligence that remembers what it said, scores what happened, admits what changed, reviews prior calls, and turns unresolved market conditions into governed decisions. Structurally ready; release authority remains pending.',
    availability: 'inactive',
    route: '/offers/global-market-intelligence-q2',
    checkoutProductCode: 'gmi_q2_2026',
    priceLabel: getProductDisplayPrice('gmi_q1_2026'),
    primaryCTA: 'Await release authority',
    governed: true,
    live: true,
    purchasable: false,
    gatedReason: 'Market-ready release candidate — final post-8-July data lock and owner release authority pending.',
    shouldAppearOnProducts: true,
    shouldAppearOnPricing: false,

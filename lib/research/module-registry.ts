...
export const MODULE_REGISTRY: ModuleRegistryEntry[] = [
  ...
  },
  {
    ...
    status: "WIRED",
    description: "Abraham of London editorial house style checker. UK/US spelling drift, overclaim phrases, guarantee language, hidden compliance assertions, AI prediction claims, evidence posture, authority claim leakage. No AI.",

...
export const TOOLKITS: Toolkit[] = [
  ...
  },
  {
    ...
    components: ["Board authority mapping", "Oversight protocol framework", "Accountability enforcement system", "Ethical guardrail model", "Strategic monitoring dashboard", "Escalation trigger protocol"],
    outputs: ["Board Authority Matrix", "Accountability Register", "Board Dashboard", "Escalation Protocol", "Outcome Audit Report"],
    linkedFrameworks: ["EG-01", "PD-31", "AI-02"],
    linkedProducts: ["mandate_clarity_framework", "executive_reporting", "strategy_room"],
    tier: "enterprise",
  },
  {

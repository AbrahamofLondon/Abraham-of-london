// lib/vault-engine.ts — VAULT SSOT (Prisma + optional Redis cache)
   ...
   * Post-enum-expansion: PolicyAccessTier and DbAccessTier share the same
   * 9-value canonical underscore-flat vocabulary. This is a direct pass
   ...
   * Post-enum-expansion: the two vocabularies are identical, so this
   * reduces to canonical normalization.
   */

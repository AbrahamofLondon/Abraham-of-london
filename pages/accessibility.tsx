          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gold/20 p-8 mb-8">
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>Email: <a href="mailto:info@abrahamoflondon.com" className="text-gold hover:text-amber-200 transition-colors">info@abrahamoflondon.com</a></li>
                  <li>Phone: +44 (0)208 0622 5909</li>
                </ul>
              </section>

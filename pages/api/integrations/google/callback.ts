/**
 * pages/api/integrations/google/callback.ts
...
const SUCCESS_REDIRECT = `${SITE_URL}/settings/integrations?success=google_calendar`;
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  res.setHeader(
    "Set-Cookie",
    `oauth_state=; HttpOnly; Secure=${process.env.NODE_ENV === "production"}; SameSite=Lax; Path=/api/integrations/google; Max-Age=0`,
  );

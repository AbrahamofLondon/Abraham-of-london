...
import BookCard from '../components/BookCard'; // Import as default, no curly braces

// This is a simplified example; you'll need actual data fetching (getStaticProps) for real books
interface Book {
  slug: string;
  title: string;
  coverImage: string;
  ...
  const books: Book[] = [
    {
      ...
      coverImage: '/assets/images/fathering-without-fear.webp', // Ensure this path is correct

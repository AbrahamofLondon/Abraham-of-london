          ...
          <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-4 pb-16 pt-16 md:flex-row md:items-center md:pb-20">
            ...
            <div className="flex-1 space-y-6">
              ...
              <p className="pt-3 text-[0.8rem] text-gray-400">
                This is <strong>Volume 0</strong> thinking: setting the frame so
                every decision, project, and covenant sits inside a coherent
                architecture — not vague &ldquo;purpose talk&rdquo;.
              </p>
            </div>
          ...
          <div className="grid gap-10 md:grid-cols-2">
            <div className="space-y-4">
              ...
              <p className="text-sm leading-relaxed text-gray-200 sm:text-base">
                ...
                you the <strong>blueprint skeleton</strong>. You’ll see how{" "}
            ...
            <div className="rounded-3xl border border-white/10 bg-black/40 p-6 shadow-[0_14px_40px_rgba(0,0,0,0.85)]">
              ...
              <ul className="mt-4 space-y-3 text-sm text-gray-200">
                <li>
                  • Why <strong>purpose</strong> cannot be defined in isolation
                  from civilisation and covenant.
                </li>
                <li>
                  • The difference between <strong>calling</strong>,{" "}
                  <strong>assignment</strong>, and <strong>occupation</strong>.
                </li>
                <li>
                  • How <strong>time, authority, and responsibility</strong>{" "}
                  shape destiny more than raw talent.
                </li>
                <li>
                  • Why fatherhood and stewardship sit at the{" "}
                  <strong>load-bearing walls</strong> of any culture.
                </li>
              </ul>
        ...
        <section className="border-t border-white/10 bg-gradient-to-r from-forest/90 via-forest to-forest/90 py-14">
          <div className="mx-auto max-w-4xl px-4 text-center text-cream">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-cream/90 sm:text-base">
              ...
              new volumes are released. This is where{" "}
              <strong>Fathering Without Fear</strong> and the broader Abraham of
              London Canon quietly intersect.
            </p>

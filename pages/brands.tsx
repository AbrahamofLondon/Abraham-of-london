...
// âœ… Using SEOHead for cleaner metadata management
...
const BRANDS = [
  {
    name: "InnovateHub", // âœ… ADDED NEW BRAND
...
export default function BrandsPage() {
  ...
  return (
    <Layout>
      {/* âœ… UPGRADE: Using SEOHead component */}
      <SEOHead
        title={pageTitle}
      ...
      <main className="relative min-h-screen pt-20 pb-12 overflow-x-hidden">
        ...
        <div className="container relative z-10 mx-auto max-w-6xl px-4">
          ...
          <motion.section
            ...
            // âœ… UPGRADE: Using theme colors: text-deepCharcoal, bg-white, shadow-xl
            ...
            >
              {ventures.map((brand) => (
                <motion.div
                  ...
                  // âœ… UPGRADE: Using theme colors and border for a polished look
                ...
                >
                  ...
                  >
                    ...
                    <div className="text-center">
                      ...
                      {/* âŒ FIX: Explicitly wrap the opacity value in square brackets to pass Tailwind checks. */}
                      <p className="mb-4 text-[color:var(--color-on-secondary)]/[0.9]">{brand.description}</p>
                      <div className="flex flex-wrap justify-center gap-2">
                        {brand.tags.map((tag) => (
                          <span
                            key={tag}
                            // âœ… UPGRADE: Using theme colors for tags
                            // âŒ FIX: Explicitly wrap the opacity value in square brackets to pass Tailwind checks.
                      ...
                      <span className="mt-4 inline-block text-sm font-medium text-forest hover:underline">
                          {brand.url.startsWith("/") ? "View Details â†’" : "Visit Site â†’"}
                      </span>
                    </div>
                  </a>
                </motion.div>
          ...
          {/* Call to action */}
          <motion.section
            // âœ… UPGRADE: Using theme colors (bg-forest, text-cream)
          ...
          >
            ...
            <Link
              href="/contact"
              // âœ… UPGRADE: Using theme colors for reverse button (bg-cream, text-forest)

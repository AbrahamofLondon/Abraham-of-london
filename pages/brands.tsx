...
export default function BrandsPage() {
  ...
  if (!mounted) return <Layout><div className="min-h-screen" /></Layout>;
        ...
        <div className="container max-w-6xl mx-auto px-4 relative z-10">
          ...
          >
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 relative z-10">
              ...
              >
                <h1 className="text-4xl md:text-5xl font-bold mb-3 text-gray-800">Abraham of London</h1>
                <p className="text-lg text-gray-700 leading-relaxed max-w-prose">
                  The core brand representing my personal work, vision, and philosophy. It serves as the foundation
                  for my thought leadership, strategic advisory, and creative ventures.
                </p>
              </motion.div>
            </div>
          </motion.section>
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              brands that don’t just exist, but actively work to shape their industries and enrich the lives of their communities.
            </p>
          </motion.section>
          ...
          >
            <motion.div className="text-center mb-10" variants={itemVariants}>
              <h2 className="text-4xl font-bold text-gray-800">Ventures & Brands</h2>
              <p className="text-lg text-gray-600 max-w-xl mx-auto mt-4">
                These are the ventures and projects that are an extension of the core AbrahamofLondon brand.
              </p>
            </motion.div>

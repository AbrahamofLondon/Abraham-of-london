...
/* pages/briefs/institutional-alpha.tsx — Institutional Alpha Series */
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  const briefs = (getAllBriefs() || [])
    ...
    .filter((doc: any) => {
      ...
      return sl.startsWith("institutional-alpha") || series === "institutional-alpha";
    })
    .map((doc: any) => {
      const sl = slugForDoc(doc);
...
const InstitutionalAlphaPage: NextPage<InferGetStaticPropsType<typeof getStaticProps>> = ({ briefs }) => (
  <Layout
    title="Institutional Alpha | Intelligence Briefs | Abraham of London"
    description="25 intelligence briefs on institutional intelligence failure, reporting decay, false confidence, and the discipline of decision-grade insight."
    canonicalUrl="/briefs/institutional-alpha"
    fullWidth
    headerTransparent
  >
    <Head>
      <meta name="robots" content="index,follow" />
      <meta property="og:image" content="https://www.abrahamoflondon.org/assets/images/covers/briefs/institutional-alpha-cover.webp" />
      <meta property="og:image:width" content="1200" />
      <meta property="og:image:height" content="630" />
      <meta property="og:image:alt" content="Abraham of London — Institutional Alpha" />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:image" content="https://www.abrahamoflondon.org/assets/images/covers/briefs/institutional-alpha-cover.webp" />
    ...
    <main className="min-h-screen px-6 py-24 text-white" style={{ backgroundColor: "rgb(3,3,5)" }}>
      <div className="mx-auto max-w-6xl space-y-12">
        ...
        <nav style={{ ...mono, fontSize: "11px", letterSpacing: "0.22em", textTransform: "uppercase" }}>
          ...
          <span style={{ color: ACCENT }}>Institutional Alpha</span>
        </nav>
        ...
        <header className="border border-white/10 bg-white/[0.02] p-8">
          ...
          <p className="mt-5 max-w-3xl text-sm leading-7 text-white/60">
            {briefs.length} briefs examining the conditions under which institutional intelligence
            fails. Covers reporting decay, false confidence from aggregated metrics, the breakdown of
            field intelligence, and the discipline required to produce decision-grade insight inside
            operating institutions.
          </p>
          <p className="mt-4 max-w-3xl text-sm leading-7 text-white/40">
            Each brief identifies a specific failure pattern. The Canon establishes the standard against
            which these patterns are measured. The Inner Circle applies the diagnostic to specific cases.
          </p>
          <div className="mt-8 flex flex-wrap gap-4">
            <Link
              ...
              style={mono}
            >
              <span style={{ fontSize: "11px", letterSpacing: "0.2em", textTransform: "uppercase" }}>Sovereign Intelligence Series</span>
...
export default InstitutionalAlphaPage;

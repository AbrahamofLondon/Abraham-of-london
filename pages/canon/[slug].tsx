/* pages/canon/[slug].tsx - HYDRATED INSTITUTIONAL VERSION (FIXED) */
...
// Central MDX utilities (do NOT sanitize source)
...
const CanonPage: NextPage<Props> = ({ canon, locked, source }) => {
  ...
  // NOTE: keep your current gate logic; tier checks can evolve later
...
export const getStaticProps: GetStaticProps<Props> = async ({ params }) => {
  ...
  // Gated: ship lock page at build-time (export-safe)

          ...
          >
            {[
              ...
              <motion.div
                ...
                whileHover={{ y: -5 }}
              >
                <service.icon className="mb-4 h-10 w-10 md:h-12 md:w-12 text-gold" />
                <h3 className="mb-4 font-serif text-lg md:text-xl font-semibold text-cream">
                  {service.title}
                </h3>
                <p className="mb-6 leading-relaxed text-gold/70 text-sm md:text-base">
                  {service.description}
                </p>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          >
              ...
              >
                {[
                  ...
                  <motion.li
                    ...
                    viewport={{ once: true }}
                  >
                    <div className="flex h-7 w-7 md:h-8 md:w-8 items-center justify-center rounded-full bg-gold text-sm font-semibold text-charcoal">
                      {index + 1}
                    </div>
                    <div>
                      <h4 className="text-cream font-semibold text-base md:text-lg">
                        {item.step}
                      </h4>
                      <p className="mt-1 text-gold/70 text-sm md:text-base">{item.description}</p>
                    </div>
                  </motion.li>
                ))}
              </motion.ol>
            ...
            >
              ...
              <p className="mb-4 md:mb-6 text-gold/80 text-sm md:text-base">

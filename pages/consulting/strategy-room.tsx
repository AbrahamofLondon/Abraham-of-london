  ...
  switch (route) {
    ...
    case "REJECT":
      return {
        ...
        description:
          "The matter is not yet ready for premium escalation. Foundational work should precede it.",
        ctaHref:
    ...
    default:
      return {
        ...
        description:
          "The signal is real, but structural readiness is incomplete. Diagnostic correction is the appropriate next step.",
        ctaHref:
...
function localSummary(canonical: CanonicalSectionsEnvelope | null) {
  ...
  return {
    ...
    interventions: Array.isArray(posture?.requiredInterventions)
      ? posture.requiredInterventions
      : [],
    narrative: safeText(posture?.narrativeSummary, ""),
    rationale: Array.isArray(posture?.rationale) ? posture.rationale : [],
    nextAction: safeText(
      canonical?.sections?.governedRecommendations?.nextAction,
      "",
    ),
  };
}
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle at center, rgba(255,255,255,0.022) 0%, transparent 65%)",
            filter: "blur(120px)",
          }}
        />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-12">
        <div className="pb-20 pt-36 md:pb-24 md:pt-44 lg:pb-28 lg:pt-52">
          ...
          >
            This is where serious operators stop browsing and start declaring the real
            problem. The room exists to test mandate fit, consequence weight,
            authority, readiness, and whether private work is justified now.
          </p>
          ...
          >
            ...
            >
              Submitting here does not guarantee acceptance. It guarantees a more
              serious reading than a contact form will ever produce. Weak signals
              are redirected — not escalated.
            </p>
          </div>
        </div>
      </div>
...
function IntakeForm({
  ...
  function FieldGroup({
    ...
    label: string;
    fields: typeof STRATEGY_ROOM_FORM_SPEC;
    cols?: 1 | 2;
  }) {
    return (
      <div>
    ...
    >
      <div className="mx-auto max-w-4xl px-6 py-16 lg:px-12 lg:py-20">
        <div className="mb-10">
          ...
          >
            Thin answers weaken the constitutional reading. Serious operators speak
            plainly about consequence.
          </p>
        </div>
          ...
          <div style={{ marginTop: "2.5rem" }}>
            <button
              ...
              style={{
                padding: "16px 28px",
                border: `1px solid ${
                  isSubmitting ? "rgba(255,255,255,0.07)" : `${GOLD}42`
                }`,
              ...
              <Link
                ...
                onClick={() => {
                  if (posture.route === "STRATEGY") {
                    void onMarkStrategyAccepted();
                  } else {
                    void onMarkDiagnosticStarted();
                  }
                }}
                  ...
                  {recs.slice(0, 4).map((item, idx) => (
                    ...
                    >
                      ...
                      {item.href && (
                        <Link
                          href={item.href}
                          className="mt-2.5 inline-flex items-center gap-1.5 transition-opacity hover:opacity-75"
                          style={{
                            fontFamily: "'JetBrains Mono', ui-monospace, monospace",
                            fontSize: "7.5px",
                            letterSpacing: "0.28em",
...
export default function StrategyRoomPage() {
  ...
  const [canonical, setCanonical] =
    React.useState<CanonicalSectionsEnvelope | null>(null);
            ...
            >
              <div className="mx-auto max-w-5xl px-6 py-12 lg:px-12">
                <div className="flex flex-col items-center gap-4 text-center">
                  ...
                  >
                    If you believe the diagnosis is incomplete, refine and resubmit.
                    The system reads what you declare, not what you imply.
                  </p>
                  <button
                    type="button"
            ...
            >
              <div className="mx-auto max-w-5xl px-6 py-10 lg:px-12">
                <div className="flex flex-col items-center gap-3 text-center">
                  ...
                  >
                    The diagnostic ladder exists for readers who are not yet ready to
                    declare their matter formally.
                  </p>
                  <Link
                    href="/diagnostics"

    ...
    <main className="flex min-h-screen items-center justify-center px-6" style={{ backgroundColor: "rgb(3,3,5)" }}>
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 space-y-3">
          ...
          <div className="flex items-center justify-center gap-2 w-full" style={{ padding: "10px", border: "1px solid rgba(255,255,255,0.08)", color: "rgba(255,255,255,0.24)", ...mono, fontSize: "7px", letterSpacing: "0.15em", textTransform: "uppercase" }}>

...
import TeamAssessmentSuite from "@/components/assessments/TeamAssessmentSuite";
...
function Atmosphere() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      <div className="absolute -left-[5%] top-0 h-[40rem] w-[40rem] rounded-full bg-amber-500/[0.03] blur-[160px]" />
      <div className="absolute right-[0%] top-[20%] h-[30rem] w-[30rem] rounded-full bg-white/[0.01] blur-[130px]" />
    </div>
  );
}
...
export default function TeamAssessmentPage() {
  return (
    <Layout
      ...
      description="Multi-respondent evidence for team-level variance, trust, and execution reality."
      className="bg-[#060609] text-white"
    >
      <Head>
        <title>Team Assessment | Abraham of London</title>
        <meta
          name="description"
          content="Multi-respondent team assessment. Maps variance, trust gaps, and execution misalignment across the institution."
        />
      </Head>
      ...
      <main className="min-h-screen bg-[#060609] text-white">
            ...
            <div className="grid gap-14 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
              <div>
                ...
                >
                  Variance, trust,
                  <br />
                  <em className="not-italic text-white/38">and execution</em>
                  <br />
                  <span className="text-amber-300/90">reality.</span>
                </motion.h1>
                ...
                >
                  One leader's perception is not evidence. This layer exists because
                  institutional misalignment is almost never visible from a single
                  vantage point.
                </motion.p>
              ...
              >
                ...
                <div className="rounded-[20px] border border-white/[0.07] bg-white/[0.02] p-5">
                  ...
                  <div className="mt-4 space-y-2">
                    {[
                      ...
                      { label: "02 Team", active: true, done: false },
                      ...
                      <div
                        key={item.label}
                        className={cn(
                          "flex items-center gap-3 rounded-[10px] px-3 py-2.5 font-mono text-[9px] uppercase tracking-[0.18em] transition",
                          item.active
                ...
                <div className="rounded-[16px] border border-white/[0.06] bg-white/[0.015] px-4 py-3.5">
                  <div className="font-mono text-[7px] uppercase tracking-[0.24em] text-white/22">Output</div>
                  <div className="mt-1.5 text-sm text-white/55">
                    Variance index, trust gap, next-layer routing
                  </div>
                </div>
              </motion.div>
            </div>
        ...
        <section className="border-b border-white/[0.05]">
          <div className="mx-auto max-w-7xl px-6 py-14 lg:px-12">
            <motion.div
              ...
              className="mb-8"
            >
              <Eyebrow>What this layer reads</Eyebrow>
            </motion.div>
            <div className="grid gap-4 sm:grid-cols-3">
              <ContextCard
                icon={Users}
                title="Variance across teams"
                body="Whether different parts of the institution are reading the same reality — or operating under conflicting maps."
                delay={0.28}
              />
              <ContextCard
                icon={Activity}
                title="Trust and execution gaps"
                body="Where trust between leadership and execution layers has degraded below the threshold required for clean decision-making."
                delay={0.34}
              />
              <ContextCard
                icon={AlertTriangle}
                title="Structural misalignment"
                body="Whether misalignment is local (one team) or systemic (structural). The distinction determines the correct intervention."
                delay={0.40}
              />
            </div>
          </div>
        ...
        <section id="suite" className="relative scroll-mt-12">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_0%,rgba(245,158,11,0.03),transparent_55%)]" />
          <div className="relative mx-auto max-w-7xl px-6 py-20 lg:px-12">
            ...
            >
              ...
              <p className="mt-3 max-w-2xl text-base leading-relaxed text-white/38">
                Use sliders to map each metric. The system calculates variance in
                real time and identifies structural misalignment before you submit.
              </p>
            </motion.div>
        ...
        <section className="border-t border-white/[0.05]">
          <div className="mx-auto max-w-7xl px-6 py-16 lg:px-12">
            <div className="relative overflow-hidden rounded-[24px] border border-amber-500/12 bg-amber-500/[0.03] p-7 md:p-10">
              <div className="pointer-events-none absolute right-0 top-0 h-48 w-48 rounded-full bg-amber-500/[0.05] blur-[80px]" />
              <div className="relative flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                <div className="space-y-2">
                  ...
                  <h2 className="font-serif text-2xl text-white md:text-3xl">
                    If variance is systemic, the next layer is Enterprise Assessment.
                  </h2>
                  <p className="max-w-xl text-sm leading-relaxed text-white/38">
                    Team misalignment that spans multiple units is an enterprise
                    problem, not a team-level fix.
                  </p>
                </div>

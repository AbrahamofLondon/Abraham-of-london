  ...
  return (
    <div className="relative flex h-[148mm] w-[105mm] flex-col overflow-hidden rounded-2xl border border-lightGrey bg-white p-4 shadow-sm print:shadow-none">
      ...
      <ol className="mb-3 list-decimal pl-5 text-[12.5px]">
        <Bullet><strong>Opening (5)</strong> ? welcome, purpose, prayer.</Bullet>
        <Bullet><strong>Scripture (15)</strong> ? read; each man shares one line.</Bullet>
        <Bullet><strong>Formation (20)</strong> ? habits / money / marriage / parenting.</Bullet>
        <Bullet><strong>Commitments (10)</strong> ? one concrete step + deadline.</Bullet>
        <Bullet><strong>Intercession (10)</strong> ? names, needs, next steps.</Bullet>
      </ol>
    ...
    >
      ...
      <style jsx global>{`
        @media print {
          ...
          /* ensure the physical size of each card matches A6 (105?148mm) */
          .print\:gap-6 { gap: 12mm !important; }
        }
      `}</style>
    </BrandFrame>
  );

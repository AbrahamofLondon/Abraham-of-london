...
import { OgHead, BreadcrumbJsonLd } from "@/lib/seo"; // ✅ add BreadcrumbJsonLd
  ...
  return (
    <Layout pageTitle="Events">
      ...
      <OgHead
        ...
        path="/events"
      />
      {/* ✅ Breadcrumb JSON-LD for SERP enhancements */}
      <BreadcrumbJsonLd
        items={[
          { name: "Home", item: "https://www.abrahamoflondon.org/" },
          { name: "Events", item: "https://www.abrahamoflondon.org/events" },
        ]}
      />

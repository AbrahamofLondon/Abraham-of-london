 ...
 *
 * Release-specific context is passed to the kernel for emphasis.
...
const SAMPLE =
  "We need to launch this product in Q2 or we miss our revenue target. The engineering team says it is not ready — there are three known critical bugs and the security review is incomplete. Sales has already pre-sold £500k based on the Q2 launch date.";
...
export default function ReleaseRiskTestPage() {
  ...
  if (signal) {
    return (
      <>
        <Head>
          <title>Release Risk Test — Foundry — Abraham of London</title>
          <meta name="description" content="Free release risk perception check — kernel-backed" />
  ...
  return (
    <Layout
      title="Release Risk Test | Foundry | Abraham of London"
      description="Test a release decision. Receive a free perception check: where the release risk is, what the readiness gap is, and the direction of the minimum viable move."
      ...
      <main className="min-h-screen" style={{ backgroundColor: "rgb(3,3,5)" }}>
        <div className="mx-auto max-w-4xl px-6 py-24 lg:px-10">
          ...
          <h1 className="font-serif text-4xl font-light italic leading-tight text-white/90 md:text-5xl">
            Test a release decision.
          </h1>
          <p className="mt-4 max-w-[54ch] text-[15px] leading-[1.85] text-white/55">
            Describe a release or launch decision you are facing. The system will return
            a free perception check — what kind of decision this is, where the readiness
          ...
          <form onSubmit={handleSubmit} className="mt-10">
            <div className="border border-white/[0.10] bg-white/[0.02]">
              <textarea
                ...
                placeholder="Describe your release situation — what is being released, what is the timeline, what are the readiness concerns, who is involved, and what is the revenue or deadline pressure?"
                rows={6}
          ...
          <div className="mt-16 border-t border-white/[0.06] pt-8">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { label: "Analysis", text: "Governed lenses assess readiness, constraint, evidence, and adversarial pressure." },

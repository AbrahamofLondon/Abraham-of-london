...
// ============================================================================
// FEATURED CONTENT (controlled, link-safe, build-safe)
// ============================================================================
  ...
  return (
    <Layout title={siteTitle}>
      ...
      <main className="min-h-screen bg-gradient-to-b from-black via-deepCharcoal to-black text-white">
        ...
        {/* PRIORITY CONTENT */}
        <section className="mx-auto max-w-6xl px-4 py-24 space-y-16">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {featuredPosts.map((post) => (
                ...
                >
                  ...
                  <h3 className="mt-2 font-serif text-lg font-semibold text-white">{post.title}</h3>
                  <p className="mt-2 text-sm text-gray-200 line-clamp-3">{post.excerpt}</p>
                  <Link
                    href={`/${post.slug}`}
          ...
          <div>
            <div className="mb-6 flex items-center justify-between gap-3">
              <h2 className="font-serif text-3xl font-semibold text-white">Books & manuscripts</h2>
              <Link
                href="/books"
                className="text-sm font-semibold text-softGold underline-offset-4 hover:underline"
              >
                ...
                >
                  <div className="flex justify-between items-start gap-3">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-serif text-lg font-semibold text-white">{book.title}</h3>
                    </div>
          ...
          <div>
            <div className="mb-6 flex items-center justify-between gap-3">
              <h2 className="font-serif text-3xl font-semibold text-white">Events & gatherings</h2>
              <Link
                href="/events"
                className="text-sm font-semibold text-softGold underline-offset-4 hover:underline"
              >
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {featuredEvents.map((ev) => (
                <motion.article
                  ...
                  viewport={{ once: true, margin: "-80px" }}
                >
                  <p className="text-xs uppercase tracking-wide text-gray-300">{ev.dateLabel}</p>
                  <h3 className="mt-1 font-serif text-lg font-semibold text-white">{ev.title}</h3>
                  {ev.location && (
          ...
          <div>
            <div className="mb-6 flex items-center justify-between gap-3">
              <h2 className="font-serif text-3xl font-semibold text-white">Strategic downloads</h2>
              <Link
                href="/downloads"
                className="text-sm font-semibold text-softGold underline-offset-4 hover:underline"
              >
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {featuredDownloads.map((dl) => (
                ...
                >
                  ...
                  <h3 className="mt-2 font-serif text-base font-semibold text-white">{dl.title}</h3>
                  <p className="mt-2 text-xs text-gray-200 line-clamp-3">{dl.blurb}</p>
                  <Link

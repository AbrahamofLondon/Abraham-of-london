    ...
    <Layout>
      ...
      <Section title="Ventures & Brands">
        <div className="grid grid-cols-2 items-center justify-items-center gap-8 md:grid-cols-4">
          <LogoTile src={abrahamLogo} alt="Abraham of London" className="hover:scale-105 transition-transform duration-300" />
          <LogoTile src={alomaradaLogo} alt="Alomarada Ltd" className="hover:scale-105 transition-transform duration-300" />
          <LogoTile src={endureluxeLogo} alt="Endureluxe Ltd" className="hover:scale-105 transition-transform duration-300" />
          <Link href="/ventures" aria-label="View InnovateHub on the Ventures page" className="contents">
            <LogoTile src={innovatehubLogo} alt="InnovateHub" className="hover:scale-105 transition-transform duration-300" />
          </Link>
        </div>
      </Section>

        ...
        <div className="mx-auto max-w-6xl space-y-8">
          ...
          <section className="grid gap-4 md:grid-cols-4">
            {[
              ...
              <article key={String(label)} className="border border-white/10 bg-white/[0.015] p-5">
                <p style={{ ...mono, fontSize: "8px", letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(255,255,255,0.38)" }}>{label}</p>
          ...
          <section className="grid gap-5 lg:grid-cols-3">
            <article className="border border-emerald-500/15 bg-emerald-500/[0.04] p-5">
              <p style={{ ...mono, fontSize: "8px", letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(167,243,208,0.72)" }}>Confirmed</p>
            ...
            <article className="border border-amber-500/15 bg-amber-500/[0.04] p-5">
              <p style={{ ...mono, fontSize: "8px", letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(252,211,77,0.72)" }}>Pending / carried forward</p>
            ...
            <article className="border border-rose-500/15 bg-rose-500/[0.04] p-5">
              <p style={{ ...mono, fontSize: "8px", letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(254,205,211,0.72)" }}>Weak / disconfirmed</p>

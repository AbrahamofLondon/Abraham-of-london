...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  return { props: { dii: JSON.parse(JSON.stringify(dii)) } };
};

export default function MarketDiiPage({ dii }: { dii: any }) {
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: 24, fontFamily: "Georgia, serif", color: "rgba(255,255,255,0.82)", background: "#0a0a0b" }}>
      ...
      <p style={{ fontSize: 12, color: "rgba(255,255,255,0.4)", marginBottom: 24 }}>
        Methodology v{dii.methodologyVersion} · Generated {new Date(dii.generatedAt).toLocaleDateString()}
      </p>

...
export default function NewsletterPage(): JSX.Element {
  ...
  return (
    <Layout
      title={pageTitle}
      description="Receive the Inner Circle briefing - a curated brief for founders, boards, and leaders under consequence. High-signal strategic briefing and early access to mandates."
                  ...
                  {[
                    {
                      ...
                      desc: "Early access to private salons, board retreats, and limited advisory mandates before they are broadly announced."
                    },
                    {
                      icon: BookOpen,

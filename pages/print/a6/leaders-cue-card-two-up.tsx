    ...
    <>
      ...
      <main className="sheet">
        ...
        <section className="card">
          ...
          <ul>
            ...
            <li>What is the next irreversible step?</li>
      ...
      <style jsx global>{`
        ...
        .sheet {
          ...
          display: grid; gap: 10mm;
          grid-template-rows: 1fr 1fr;
        }
        .card {
          box-sizing: border-box;
          width: 100%; height: 100%;
          border: 0.6pt solid #dadada; border-radius: 6pt;
          padding: 8mm;
          font: 10pt/1.45 var(--font-sans, ui-sans-serif);
          display: flex; flex-direction: column; justify-content: space-between;
        }
        h1 { font: 700 12pt/1.2 var(--font-serif, Georgia); margin: 0 0 4mm; }
        h2 { font: 600 10pt/1.2 var(--font-serif, Georgia); margin: 3mm 0 2mm; }

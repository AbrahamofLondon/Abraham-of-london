...
export default function BoardInvestorTemplate() {
  return (
    ...
    >
      ...
      <p className="italic text-sm opacity-80">Be brutally honest in this section. Facts, not optimism.</p>
      ...
      <p className="opacity-90">
        Include <em>one</em> visual aid: a small chart showing revenue growth, burn rate, or customer retention over the
        last 6 months.
      </p>

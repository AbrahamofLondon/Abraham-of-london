      ...
      <main className="page">
        ...
        <section className="section">
          ...
          <ul className="bullets">
            <li><strong>Scripture (≈45m):</strong> Read &amp; discuss for grounding.</li>
            <li><strong>Formation (≈30m):</strong> Habits, money, marriage, parenting.</li>
            <li><strong>Intercession (≈15m):</strong> Names, needs, next steps.</li>
          </ul>
        </section>

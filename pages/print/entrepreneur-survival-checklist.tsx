...
// FIX: Using the correct relative path (../../) to get from pages/print/ to components/print/
...
                        <li><strong>Cash today / this month / next month</strong>.</li>
                        <li><strong>Customers</strong> — who must not churn; call them.</li>
                        <li><strong>Covenants</strong> — bank, board, suppliers: align the story.</li>
                    </ol>
...
                    <Note title="Action">
                        <p className="note-p">Printable checklist included in the full download. Use it to check your vitals daily.</p>
                    </Note>
                </section>

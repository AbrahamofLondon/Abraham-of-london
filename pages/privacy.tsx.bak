    ...
    <Layout pageTitle="Privacy Policy">
      ...
      <section className="mx-auto max-w-3xl rounded-lg bg-white px-6 py-12 shadow-2xl">
        ...
        <div className="prose prose-neutral max-w-none text-gray-800">
          <p>
            At Abraham of London, we are committed to protecting your privacy. This policy explains
          ...
          <p>
            ...
            content when you submit a contact form or subscribe to our newsletter. We also collect
            non-personal information (e.g., browser type, IP address) for analytics.
          </p>

          <h2>How We Use Your Information</h2>
          <p>
            We use your information to respond to inquiries, send updates, and improve our services.
            We do not sell or rent your personal data to third parties.
          </p>

          <h2>Data Security</h2>
          <p>
            We implement reasonable security measures to protect your data, but no online
          ...
          <p>
            ...
            <a href="mailto:info@abrahamoflondon.org" className="underline decoration-forest/40 hover:decoration-forest">
          ...
          <p>
            See also our{" "}
            <Link href="/terms" className="text-forest underline decoration-forest/40 hover:decoration-forest">
              Terms of Service
            </Link>
            .
          </p>

  ...
  return (
    <Layout pageTitle="Terms of Use">
      ...
      <main className="mx-auto max-w-3xl px-4 py-16 prose prose-slate dark:prose-invert">
        ...
        <p>
          All content, trademarks, and branding are the property of Abraham of London or its licensors. Limited
          personal, non-commercial use is granted; all other rights are reserved.
        </p>

        <h2>4. Third-Party Links</h2>
        <p>
          Links to third-party sites (e.g., social platforms, booking tools) are provided for convenience. We are not
          responsible for their content or practices.
        </p>

        <h2>5. No Professional Advice</h2>
        <p>Information is provided for general purposes only and does not constitute legal, financial, or other professional advice.</p>

        <h2>6. Limitation of Liability</h2>
        <p>
          To the fullest extent permitted by law, we are not liable for any indirect, incidental, special, consequential, or punitive
        ...
        <p>
          Questions? Email{" "}
          <a href="mailto:info@abrahamoflondon.org">info@abrahamoflondon.org</a>. See also our{" "}

            ...
            {brands.map((b) => {
              ...
              const Card = (
                <motion.article
                  key={b.name}
                  variants={item}
                  className="flex flex-col rounded-2xl bg-white p-6 shadow-md ring-1 ring-black/10 hover:shadow-lg transition-shadow"
                >
              ...
              return internal ? (
                <Link key={b.name} href={b.href} className="block focus:outline-none focus-visible:ring-2 focus-visible:ring-forest/40 rounded-xl">
                  {Card}
                </Link>
              ) : (
                <a
                  ...
                  className="block focus:outline-none focus-visible:ring-2 focus-visible:ring-forest/40 rounded-xl"
                >
                  {Card}
                </a>
              );

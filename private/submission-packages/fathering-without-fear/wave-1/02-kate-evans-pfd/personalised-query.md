# Personalised Query Letter — Kate Evans, Peters Fraser & Dunlop
...
**Format when sent:** Pasted in email body or as Word attachment; chapter outline and sample chapters as separate attachments
...
- Opening paragraph draws on Evans's verified statement of nonfiction interest (PFD profile); phrase "extraordinary texture of personal experience" echoes her language directly — do not alter
- The phrase "passionate manifesto" is from her profile ("passionate manifestos from experts in their field") — this signals the author's voice, not merely the subject
- The closing sentence of the opening paragraph ("made you the right agent to approach first among PFD's list") establishes the PFD exclusivity naturally without requiring an explicit statement of it
- Closing line notes the attachments: chapter outline + three sample chapters; adapt if only one type of material is sent
- Evans does not require Word-only format; PDF is acceptable

# Personalised Query Letter — Elise Dillsworth, Elise Dillsworth Agency
...
**Format when sent:** This query letter is the cover letter for the nonfiction proposal package — attach it as the first page of the proposal, or send as a separate covering email with the proposal as attachment
...
I have attached a full nonfiction proposal, including chapter outline and a thirty-page writing sample. The complete manuscript is available on request.
...
- Opening paragraph draws on Dillsworth's career history (Virago, Diversity in Publishing Network) and her stated interests (memoir, autobiography, international writing) — all verified publicly
- "Work that is international in arc" names the book's actual geographic span: Nigeria (Isua, Lagos, Akure, Awka) → UK (Norwich, London)
- "Refuses both the memoir-as-grievance and the memoir-as-testimony" — this positioning is specifically calibrated for an editor/agent whose background includes Virago, a press attentive to the difference between protest literature and literary form
- The closing paragraph references the attached proposal — ensure the proposal is ready before sending
- Dillsworth runs her own agency and is the sole reader; write to her as a peer — not as a gatekeeper

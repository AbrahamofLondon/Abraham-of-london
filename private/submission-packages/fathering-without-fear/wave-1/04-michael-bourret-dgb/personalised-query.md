# Personalised Query Letter — Michael Bourret, Dystel Goderich & Bourret

**Version:** Wave 1 — ready for final review before send
**Route:** QueryManager only — paste into form at dystel.com
**Do NOT email this query** — email submissions to DGB are deleted unread

---

## Query Letter Text (for QueryManager form)
...
A nonfiction proposal and sample chapter are available on request, or I can provide them through this submission if the form allows.
...
## Author Bio (for QueryManager bio field — 150–200 words)
...
The book draws on his own family's history — a lineage that begins with a tailor in Isua, in Ondo state, and traces four generations to the author's present life in London. The memoir moves through fatherhood, faith, inheritance, diaspora, and the institutional pressures on a Black British father, in short chapters shaped by restraint rather than argument.

He is querying you directly, without representation. The complete manuscript is available on request.

---

## Condensed Synopsis (for QueryManager synopsis field — ~300 words)
...
The book closes with his son rendered wholly as a child — through football, swimming, vocabulary, a sentence: "I am not your bro. I am your son."

*Fathering Without Fear* is approximately 50,000 words across twenty-seven chapters. It is a compressed literary memoir about inheritance, faith, and the cost of remaining present.

---

## Notes on This Version

- "Breaks the mold" and "BIPOC literature" are direct quotes from Bourret's DGB profile — these echoes are deliberate; he will recognise his own language
- Do not frame faith content as Christian testimony — the faith strand is described as "a faith tested early"; this is a personal and ancestral inheritance, not an evangelical position
- The synopsis is designed for a US agent — it names structural elements clearly and closes with the child's voice; US agents tend to reward narrative momentum in synopses
- Do not mention Sharon Pelletier or any other DGB agent in any communication with Bourret

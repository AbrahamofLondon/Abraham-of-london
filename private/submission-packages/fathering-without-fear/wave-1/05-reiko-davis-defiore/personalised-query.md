...
[Insert the opening of the manuscript here — Ch.1 through as much of Ch.4 as reaches approximately 20 pages / 5,000 words. Extract from `01-clean-manuscript.md` or the individual draft files. Begin with the chapter heading "Chapter 1 — Hounslow Call" and continue consecutively through Chapters 1, 2, 3, and 4.]
...
Total: approximately 5,071 words / 20 pages at 250 words per page.

If the pasted text loses formatting, ensure chapter headings are clearly demarcated (capitalised or bolded) so the structure reads clearly in plain email.

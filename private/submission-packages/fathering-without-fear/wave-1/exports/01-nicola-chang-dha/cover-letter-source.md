# Cover Letter Source — Nicola Chang, David Higham Associates

**This file is the source text for the DOCX export. Copy into Word, format per DHA standards, then scrub metadata.**

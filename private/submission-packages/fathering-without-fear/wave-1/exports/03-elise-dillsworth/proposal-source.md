# Proposal Source — Elise Dillsworth, Elise Dillsworth Agency

**This file is the source text for the full nonfiction proposal DOCX. Copy into Word, format per standards, then scrub metadata.**

**Proposal structure:** Overview / Pitch → Author Bio → Chapter Outline → Writing Sample (30 pages)
...
*Fathering Without Fear* is a compressed literary memoir of approximately 47,000 words. The book follows one man's effort to remain a father when nearly everything around him — grief, distance, institutional process, and time — made remaining difficult.
...
- *Homegoing* — Yaa Gyasi (multigenerational African/diaspora family narrative — architecture comparable, though this is fiction)

The book sits in conversation with the compressed grief architecture of *Grief Is for People* (Sloane Crosley, ~52K) and the spare self-interrogation of *Stay True* (Hua Hsu, ~45K), while moving through fatherhood, inheritance, faith, and institutional pressure in its own register.

**Market:** *Fathering Without Fear* is positioned for the literary memoir market with crossover potential into diaspora memoir (Nigerian-British), faith and spiritual memoir (non-devotional), and fatherhood memoir (an underrepresented category).

**Manuscript status:** Complete. Available on request.

---

## SECTION 2: Author Biography
...
He is the father of a British child. He writes about fatherhood not as a subject he has studied but as a practice he has lived through — across supervised contact rooms, legal proceedings, seven years of sustained presence, and the ordinary work of loving a child through arrangements that were not designed to hold love.

He is based in London and is seeking representation for his first book.

---

## SECTION 3: Chapter Outline

[Insert the full 24-chapter outline from `02-kate-evans-pfd/chapter-outline-source.md` — same content, formatted consistently.]

---

## SECTION 4: Writing Sample (30 pages)

**Recommended chapters (approximately 30 pages / 7,500–8,000 words):**

1. **Ch.1 — Hounslow Call** (1,541 words)
2. **Ch.2 — Isua to Agege** (976 words)
3. **Ch.3 — The Boy Who Was Already Old** (1,327 words)
4. **Ch.6 — Fire and the Deal** (2,506 words)
5. **Ch.10 — Leaving Lagos** (1,660 words)

**Total:** approximately 8,010 words (~32 pages). Trim to exactly 30 pages if a strict limit applies.

**Source:** Extract from `01-clean-manuscript.md`. Begin with "# Chapter 1 — Hounslow Call" and include the full text of each chapter listed above.

**Why this selection for Dillsworth:**
- Chs.1–3 establish the international arc she specifically values
- Ch.6 (the fire) is the book's most viscerally rendered chapter — demonstrates literary prose quality
- Ch.10 (Leaving Lagos) closes the selection at the point of departure from Lagos to London — directly illustrates the diaspora arc

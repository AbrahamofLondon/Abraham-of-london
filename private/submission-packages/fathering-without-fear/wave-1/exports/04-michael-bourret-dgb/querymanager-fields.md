# QueryManager Fields — Michael Bourret, Dystel Goderich & Bourret

**Route:** QueryManager only — navigate from dystel.com. Do not email.
...
When his son Damisi was born, fatherhood did not begin inside a home. It began outside one. What followed were years of distance, waiting, and the quiet discipline of loving a child through arrangements that could record a visit but could not record what happened inside it.
...
A nonfiction proposal and sample chapter are available on request.
...
## FIELD: Author Bio (150–200 words)

Abraham Adaramola, writing as Abraham of London, is a Nigerian-British writer. He was born in Lagos, raised across the south-west of Nigeria, and has lived in London for more than two decades. *Fathering Without Fear* is his debut memoir.

The book draws on his own family's history — a lineage that begins with a tailor in Isua, in Ondo state, and traces four generations to the author's present life in London. The memoir navigates fatherhood, faith, inheritance, diaspora, and the institutional pressures on a Black British father — written with the formal discipline and deliberate compression of a writer who has lived with the material for a long time before committing it to the page.

He is querying you directly, without representation. The complete manuscript is available on request.

---

## FIELD: Synopsis / Proposal Summary (~300 words)

*Fathering Without Fear* opens in February 2021. Abraham is sitting on his bed in Hounslow when the court calls without notification. He stays on the line — because the alternative is absence, and absence has its own danger. The book moves backward from that call into the family line, the faith, and the inheritance that made him the man holding the phone.
...
What follows are years of contact rooms, time limits, and the discipline of loving a child through arrangements that can record a visit but cannot record what happened inside it. Between those years, one chapter shows Abraham rebuilding ordinary adult life — dancing, socialising, testing whether he can remain present when someone he is close to suggests he leave London for work. He does not leave. His son is in London. So he stays.
...
*Fathering Without Fear* is approximately 47,000 words across twenty-four chapters. It is a compressed literary memoir about inheritance, faith, and the cost of remaining present.

---

## FIELD: Sample Pages / Sample Chapter

**Recommended:** Chapter 1 — Hounslow Call (1,541 words)

**Alternative if minimum word count required:** Add Chapter 6 — Fire and the Deal (2,506 words) for a combined total of ~4,047 words.

**Source:** Extract from `01-clean-manuscript.md`.

---

## FIELD: Genre

Narrative Nonfiction / Literary Memoir
...
- *Between the World and Me* by Ta-Nehisi Coates (compressed, morally serious personal narrative addressed to a child, BIPOC perspective, institutional pressure)
- *The Warmth of Other Suns* by Isabel Wilkerson (multigenerational migration narrative; the ancestral arc; historical weight)
- *Know My Name* by Chanel Miller (personal testimony that transcends the specific incident to become a larger statement; literary quality; the refusal of victimhood as identity)

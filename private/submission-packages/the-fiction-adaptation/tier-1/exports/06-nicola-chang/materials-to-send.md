# Materials to Send (Export Copy) — Nicola Chang, David Higham Associates
...
**Required:** Query letter + synopsis + opening sample (confirm current length).
...
Full planning detail: `tier-1/06-nicola-chang/materials-to-send.md`.

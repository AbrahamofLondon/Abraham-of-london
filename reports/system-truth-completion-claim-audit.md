...
| --- | ---: | --- | --- | --- |
| reports/adversarial-free-signal-adoption-layer.md | 90 | complete | requires_evidence_check | \| Complete fallback path \| ❌ Forbidden \| ✅ Included \| |
| reports/adversarial-free-signal-adoption-layer.md | 129 | ready | requires_evidence_check | **READY_FOR_STRIPE_TEST_SMOKE** |
| reports/anti-gaming-validation-hardening.md | 4 | complete | requires_evidence_check | **Status**: HARDENING COMPLETE; WAVE 2G UPGRADE REJECTED |
| reports/anti-gaming-validation-hardening.md | 72 | complete | requires_evidence_check | - evidenceLedgerComplete !== true |
| reports/anti-gaming-validation-hardening.md | 107 | complete | requires_evidence_check | - ✓ Full validation chain complete (anti-toy + red-team + generic-AI + market) |
...
| reports/CATEGORY_DEMONSTRATION_BUILD_HONEST_ASSESSMENT.md | 73 | ready | requires_evidence_check | ### UI Components: Deployed and Ready ✓ |
| reports/CATEGORY_DEMONSTRATION_BUILD_HONEST_ASSESSMENT.md | 109 | ready | requires_evidence_check | \| Fast Diagnostic Entry \| not_category_ready \| Overclaim risk: claims without evidence \| |
| reports/CATEGORY_DEMONSTRATION_BUILD_HONEST_ASSESSMENT.md | 211 | verified | requires_evidence_check | - Verified all product authority states are correct |
| reports/CATEGORY_DEMONSTRATION_BUILD_HONEST_ASSESSMENT.md | 329 | complete | requires_evidence_check | **Honest Verdict:** Infrastructure Complete. Visibility Gap Identified. Path Forward Clear. |
| reports/CATEGORY_SURFACE_INTEGRATION_EXECUTION_BRIEF.md | 4 | ready | requires_evidence_check | **Status:** READY FOR IMPLEMENTATION |
| reports/CATEGORY_SURFACE_INTEGRATION_EXECUTION_BRIEF.md | 83 | done | unknown | ## What Needs to Be Done |
| reports/CATEGORY_SURFACE_INTEGRATION_EXECUTION_BRIEF.md | 226 | ready | requires_evidence_check | ## Code Template (Copy-Paste Ready) |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 1 | complete | requires_evidence_check | # Category Surface Integration Setup — Complete |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 4 | ready | requires_evidence_check | **Status:** INFRASTRUCTURE READY FOR ROUTE INTEGRATION |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 33 | ready | requires_evidence_check | - Products: All 4 configured and ready to resolve |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 61 | ready | requires_evidence_check | Ready to wire into each route. |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 107 | complete | requires_evidence_check | ✓ Integration guide: Complete |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 108 | ready | requires_evidence_check | ✓ Wrapper component: Ready |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 160 | ready | requires_evidence_check | Just wire the ready-made components into 5 routes and authority becomes visible. |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 172 | complete | requires_evidence_check | 4. `reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md` — This report |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 182 | ready | requires_evidence_check | ## Validation Commands Ready |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 236 | ready | requires_evidence_check | Overall Status: category_foundation_ready (or better) ✓ |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 260 | ready | requires_evidence_check | Category demonstration: Ready to implement |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 261 | ready | requires_evidence_check | Market-ready status: One phase away |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 268 | ready | requires_evidence_check | - The fix is simple and ready to execute |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 285 | ready | requires_evidence_check | ## Ready Signal |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 287 | ready | requires_evidence_check | **Status:** READY TO INTEGRATE |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 293 | ready | requires_evidence_check | - ✓ Ready to implement |
| reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md | 300 | complete | requires_evidence_check | **Setup Status:** COMPLETE |
| reports/CATEGORY_SURFACE_ROUTE_INTEGRATION_COMPLETE.md | 4 | complete | requires_evidence_check | **Status:** ✓ COMPLETE |
| reports/CATEGORY_SURFACE_ROUTE_INTEGRATION_COMPLETE.md | 70 | complete | requires_evidence_check | - All with complete authority detail visibility |
| reports/CATEGORY_SURFACE_ROUTE_INTEGRATION_COMPLETE.md | 94 | complete | requires_evidence_check | Infrastructure Completeness: PASSED (4/4) |
| reports/CATEGORY_SURFACE_ROUTE_INTEGRATION_COMPLETE.md | 146 | complete | requires_evidence_check | 4. `reports/CATEGORY_SURFACE_INTEGRATION_SETUP_COMPLETE.md` — Setup summary |
...
| reports/ESTATE_WIDE_CATEGORY_DEMONSTRATION_EXPANSION_COMPLETE.md | 311 | complete | requires_evidence_check | **Category Surface Route Integration:** ✓ COMPLETE |
| reports/ESTATE_WIDE_CATEGORY_DEMONSTRATION_EXPANSION_COMPLETE.md | 316 | ready | requires_evidence_check | **The system is production-ready for the 4 demonstrating routes and positioned for expansion to 6-8+ routes as organizational priorities define.** |
| reports/ESTATE_WIDE_CATEGORY_DEMONSTRATION_EXPANSION_COMPLETE.md | 322 | ready | requires_evidence_check | **Overall Status:** ✓ READY FOR MARKET DEMONSTRATION |
...
| reports/EVIDENCE_LEDGER_V2_GENERATION_INFRASTRUCTURE_PASS.md | 141 | verified | requires_evidence_check | **Boundary Status:** CLEAN — All flags false; clean pass verified |
| reports/EVIDENCE_LEDGER_V2_GENERATION_INFRASTRUCTURE_PASS.md | 163 | ready | requires_evidence_check | Gates Ready for Rerun:  ✓ YES (v2 evidence now available) |
| reports/EVIDENCE_LEDGER_V2_GENERATION_INFRASTRUCTURE_PASS.md | 178 | complete | requires_evidence_check | - Complete test results |
| reports/EVIDENCE_LEDGER_V2_GENERATION_INFRASTRUCTURE_PASS.md | 186 | complete | requires_evidence_check | This infrastructure pass is complete. The **fast_diagnostic v2 clean validation pass** can now proceed: |
| reports/EVIDENCE_LEDGER_V2_GENERATION_INFRASTRUCTURE_PASS.md | 206 | verified | requires_evidence_check | - ✓ All measurement boundaries verified |
| reports/EVIDENCE_LEDGER_V2_GENERATION_INFRASTRUCTURE_PASS.md | 224 | complete | requires_evidence_check | **Infrastructure Pass Status:** COMPLETE |
| reports/FAST_DIAGNOSTIC_V2_CLEAN_VALIDATION_FINAL.md | 25 | authority granted | requires_evidence_check | \| Release Authority Firewall \| ✓ PASSED \| Authority granted based on v2 evidence \| |
| reports/FAST_DIAGNOSTIC_V2_CLEAN_VALIDATION_FINAL.md | 29 | ready | requires_evidence_check | \| Product Gold Release Readiness \| ✓ PASSED \| Ready for release \| |
| reports/FAST_DIAGNOSTIC_V2_CLEAN_VALIDATION_FINAL.md | 81 | complete | requires_evidence_check | ✓ Evidence Ledger v2 is valid and complete |
| reports/FAST_DIAGNOSTIC_V2_CLEAN_VALIDATION_FINAL.md | 118 | complete | requires_evidence_check | ## Infrastructure Completed |
| reports/FAST_DIAGNOSTIC_V2_CLEAN_VALIDATION_FINAL.md | 170 | complete | requires_evidence_check | - ✓ Evidence Ledger v2 valid and complete |
| reports/FAST_DIAGNOSTIC_V2_CLEAN_VALIDATION_FINAL.md | 181 | complete | requires_evidence_check | **Validation Pass:** COMPLETE |
| reports/INFRASTRUCTURE_REPAIR_PASS.md | 4 | complete | requires_evidence_check | **Status:** COMPLETE |
...
| reports/kernel-reality-proof/scenario-01-hmrc-filing-rescue.md | 531 | complete | requires_evidence_check | **Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-02-board-political-pressure.md | 4 | complete | requires_evidence_check | **Kernel Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-02-board-political-pressure.md | 523 | complete | requires_evidence_check | **Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-03-market-claim-weak-proof.md | 4 | complete | requires_evidence_check | **Kernel Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-03-market-claim-weak-proof.md | 404 | complete | requires_evidence_check | **Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-04-product-launch-revenue-pressure.md | 4 | complete | requires_evidence_check | **Kernel Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-04-product-launch-revenue-pressure.md | 86 | complete | requires_evidence_check | \| Release Risk: Security review incomplete \| CRITICAL \| 0.8 \| release-risk \| |
| reports/kernel-reality-proof/scenario-04-product-launch-revenue-pressure.md | 296 | complete | requires_evidence_check | "label": "Release Risk: Security review incomplete", |
| reports/kernel-reality-proof/scenario-04-product-launch-revenue-pressure.md | 297 | complete | requires_evidence_check | "summary": "Security review incomplete", |
| reports/kernel-reality-proof/scenario-04-product-launch-revenue-pressure.md | 633 | complete | requires_evidence_check | **Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-05-procurement-supplier-risk.md | 4 | complete | requires_evidence_check | **Kernel Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-05-procurement-supplier-risk.md | 421 | complete | requires_evidence_check | **Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-06-investor-pitch-unsupported-traction.md | 4 | complete | requires_evidence_check | **Kernel Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-06-investor-pitch-unsupported-traction.md | 127 | verified | requires_evidence_check | - **Make growth or traction claims to investors without disclosing they are based on internal projections rather than verified data** (CRITICAL): Misrepresentation to investors carries both legal and regulatory risk. Projections presented as results is a known |
| reports/kernel-reality-proof/scenario-06-investor-pitch-unsupported-traction.md | 245 | verified | requires_evidence_check | "summary": "Market claim has some supporting evidence but should be verified", |
| reports/kernel-reality-proof/scenario-06-investor-pitch-unsupported-traction.md | 380 | verified | requires_evidence_check | "action": "Make growth or traction claims to investors without disclosing they are based on internal projections rather than verified data", |
| reports/kernel-reality-proof/scenario-06-investor-pitch-unsupported-traction.md | 471 | complete | requires_evidence_check | **Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-07-operational-failure-unclear-owner.md | 4 | complete | requires_evidence_check | **Kernel Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-07-operational-failure-unclear-owner.md | 408 | complete | requires_evidence_check | **Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-08-legal-admin-deadline.md | 4 | complete | requires_evidence_check | **Kernel Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-08-legal-admin-deadline.md | 460 | complete | requires_evidence_check | **Status:** COMPLETED |
| reports/kernel-reality-proof/scenario-09-cash-constrained-survival.md | 4 | complete | requires_evidence_check | **Kernel Status:** COMPLETED |

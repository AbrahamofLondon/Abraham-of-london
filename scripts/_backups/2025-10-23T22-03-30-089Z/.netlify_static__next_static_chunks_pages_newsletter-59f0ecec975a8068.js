  ...
  [1533],
  {
    ...
    4708: function (e, t, s) {
      ...
      async function l(e) {
        ...
        return t.ok && (null == s ? void 0 : s.ok)
          ? {
              ok: !0,
              message: String(s.message || "You're subscribed. Welcome!"),
            }
          : {
              ok: !1,
              message: String(
                (null == s ? void 0 : s.message) ||
                  "Subscription failed (HTTP ".concat(
                    t.status,
                    "). Please try again.",
                  ),
              ),
        ...
        async function d(s) {
          ...
          try {
            ...
            e.ok
              ? (o({
                  state: "success",
                  message: e.message || "You're subscribed. Welcome!",
                }),
                t(""))
              : o({
                  state: "error",
            ...
            o({ state: "error", message: "Network error. Please try again." });
          }
        }
        let u =
          "success" === s.state || "error" === s.state ? String(s.message) : "";
        return (0, a.jsxs)(i.Z, {
              ...
              children: (0, a.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, a.jsxs)("form", {
                    onSubmit: d,
                    className:
                      "mx-auto flex max-w-xl flex-col gap-3 rounded-2xl border border-lightGrey bg-warmWhite p-4 sm:flex-row sm:items-center sm:p-5",
                    noValidate: !0,
                    children: [
                      (0, a.jsx)("label", {
                        htmlFor: "email",

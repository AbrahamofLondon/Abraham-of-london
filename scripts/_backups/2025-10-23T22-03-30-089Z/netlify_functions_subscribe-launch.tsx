...
const WelcomeLaunchEmail: React.FC<WelcomeProps> = ({ name, siteUrl }) => {
  ...
  return (
    <div style={{ fontFamily: "ui-sans-serif,-apple-system,Segoe UI,Roboto,Arial", color: "#111827", lineHeight: 1.6 }}>
      <p>{name ? `Hi ${name},` : "Hi,"}</p>
      <p>
        Thanks for joining the <strong>Fathering Without Fear</strong> launch list. YouÃƒ¢Ã¢â€š¬Ã¢â€ž¢ll get early
      ...
      <ul>
        <li>
          <a href={`${base}/downloads/fathering-without-fear.pdf`} target="_blank" rel="noopener noreferrer">
            Teaser PDF (A4/Letter)
          </a>
        </li>
        <li>
          <a href={`${base}/downloads/fathering-without-fear-mobile.pdf`} target="_blank" rel="noopener noreferrer">
            Teaser PDF (Mobile)
          </a>
        </li>
      </ul>
      <p>
        Reach me directly by replying, or use the contact page:{" "}
        <a href={`${base}/contact`} target="_blank" rel="noopener noreferrer">{base}/contact</a>.
      </p>
      <p>Grace and courage,<br />Abraham of London</p>
      <hr style={{ border: 0, borderTop: "1px solid #e5e7eb", margin: "20px 0" }} />
      <p style={{ fontSize: 12, color: "#6b7280" }}>
        YouÃƒ¢Ã¢â€š¬Ã¢â€ž¢re receiving this because you asked to be notified about the launch. Unsubscribe: reply with <em>Ãƒ¢Ã¢â€š¬Ã…"stopÃƒ¢Ã¢â€š¬Ã‚</em>.
      </p>
    </div>
  );
};

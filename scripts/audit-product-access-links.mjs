...
function getProductAccessSurfaces(catalog) {
  ...
  const namedSurfaces = [
    { productCode: "team_assessment",       sourcePage: "/products",     linkText: "View Team Assessment",            href: "/diagnostics/team-assessment",                               expectedAccessMode: "manual_billing",  stripePriceId: catalog["team_assessment"]?.stripePriceId,       stripeProductId: catalog["team_assessment"]?.stripeProductId },
    { productCode: "enterprise_assessment", sourcePage: "/products",     linkText: "View Enterprise pathway",         href: "/enterprise",                                                expectedAccessMode: "manual_billing",  stripePriceId: catalog["enterprise_assessment"]?.stripePriceId, stripeProductId: catalog["enterprise_assessment"]?.stripeProductId },
    ...
    { productCode: "gmi_q2_2026",           sourcePage: "/products",     linkText: "View latest report — Q2 2026",   href: "/artifacts/global-market-intelligence-report-q2-2026",       expectedAccessMode: "manual_billing",  stripePriceId: catalog["gmi_q2_2026"]?.stripePriceId,           stripeProductId: catalog["gmi_q2_2026"]?.stripeProductId },

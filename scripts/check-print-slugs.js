...
import {
  getPrintSlugs,
  getPrintSlugsWithType,
} from "../lib/server/print-utils.js";
...
console.log(
  "  Type:",
  Array.isArray(slugsWithType) ? "Array" : typeof slugsWithType
);
...
const isValidForNextJS =
  Array.isArray(slugs) && slugs.every((slug) => typeof slug === "string");

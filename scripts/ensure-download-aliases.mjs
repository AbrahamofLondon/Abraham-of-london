...
function toKebabBase(name) {
  return name
    .replace(/\.pdf$/i, "")
    .replace(/[_\s]+/g, "-")
    .replace(/[A-Z]+(?![a-z])/g, (m) => m.toLowerCase()) // ACRONYMS to lower

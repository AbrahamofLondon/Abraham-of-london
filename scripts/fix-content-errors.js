...
const problematicFile = path.join(process.cwd(), 'content', '_downloads-registry.md');
...
if (fs.existsSync(blogDir)) {
  ...
  blogFiles.forEach(file => {
    ...
    content = content.replace(/<ResourcesCTA[^>]*\/>/g, '<!-- ResourcesCTA component -->');
    content = content.replace(/<BrandFrame[^>]*\/>/g, '<!-- BrandFrame component -->');

...
const TASKS = [
  { path: "/print/fathering-without-fear-teaser",         file: "Fathering_Without_Fear_Teaser.pdf" },
  { path: "/print/fathering-without-fear-teaser-mobile",  file: "Fathering_Without_Fear_Teaser-Mobile.pdf" },

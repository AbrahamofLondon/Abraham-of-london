/* tailwind.config.js - HARDENED INSTITUTIONAL VERSION (PRODUCTION-SAFE) */
/** @type {import('tailwindcss').Config} */

// ------------------------------
// Optional plugin loader (no hard build failures)
// ------------------------------
function optionalRequire(moduleName) {
  try {
    ...
    // Keep it quiet in CI; Tailwind/Next logs are noisy already.
    return null;
  }
}
...
const aspectRatio = optionalRequire("@tailwindcss/aspect-ratio");
...
module.exports = {
  ...
  content: [
    ...
    // Include Contentlayer output to prevent purged styles
  ...
  theme: {
    extend: {
      colors: {
        ...
        // Extend Tailwind palettes safely (additive)
        slate: {
          950: "#0b0d10",
        },
        amber: {
      ...
      boxShadow: {
        ...
        "card-hover":
          "0 20px 40px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(214, 178, 106, 0.1)",
      },
      ...
      backgroundImage: {
        ...
        "gold-gradient":
          "linear-gradient(135deg, #d6b26a 0%, #e6c878 50%, #fff0b3 100%)",
        "gold-gradient-subtle":
          "linear-gradient(135deg, rgba(214, 178, 106, 0.1) 0%, rgba(214, 178, 106, 0.05) 100%)",
        "dark-gradient": "linear-gradient(to bottom, #0b0d10 0%, #050608 100%)",
        "surface-gradient":
          "linear-gradient(to bottom, var(--aol-surface) 0%, rgba(0,0,0,0) 100%)",
        "radial-gold":
          "radial-gradient(circle at 50% 0%, rgba(214, 178, 106, 0.2), transparent 70%)",
        "grid-pattern":
    ...
    function ({ addUtilities }) {
      const newUtilities = {
        ...
        ".text-gradient-gold-animated": {
          background:
            "linear-gradient(90deg, #d6b26a 0%, #e6c878 25%, #fff0b3 50%, #e6c878 75%, #d6b26a 100%)",
